<?php
	...
	if ( $use_masonry_tiles_featured_image_size == 'yes' ) :
		$settings['featured_image_size'] = $meta_featured_image_size = ventiq_get_rwmb_group( 'ventiq_' . "portfolio_mb_featured_image_size_settings", 'masonry_tiles_featured_image_size' );
