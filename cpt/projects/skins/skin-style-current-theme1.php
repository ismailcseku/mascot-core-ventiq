...
class Skin_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .projects-skin-current-theme1 .inner-box .content-box' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .projects-skin-current-theme1 .inner-box .content-box' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current Icon Styling', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Button BG Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Button Icon Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current Background Styling ( Hover )', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current Icon Styling ( Hover )', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Button Icon Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme1', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme1' . $direction_suffix . '.css' );

		wp_enqueue_script( 'tm-projects-block-script', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/cpt/project-block.js', array('jquery'), false, true );
