...
class Skin_Style_Current_Theme7 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme7', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme7', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme7' . $direction_suffix . '.css' );
