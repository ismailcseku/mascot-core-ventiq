...
class Skin_Style_Current_Theme4 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme4', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme4', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme4' . $direction_suffix . '.css' );

		wp_enqueue_script( 'tm-project-block-script', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/cpt/project-block.js', array('jquery'), false, true );
