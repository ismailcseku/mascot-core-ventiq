...
class Skin_Style_Current_Theme6 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme6', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme6', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme6' . $direction_suffix . '.css' );


		//gsap pin spacer added
		wp_enqueue_script( 'gsap' );
		wp_enqueue_script( 'gsap-scrolltrigger' );
		wp_enqueue_script( 'tm-gsap-pin-scroll', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/gsap-pin-scroll.js', array('jquery'), false, true );
