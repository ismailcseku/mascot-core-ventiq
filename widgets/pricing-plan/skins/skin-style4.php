...
class Skin_Pricing_Style4 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Pricing Style4', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-pricing-skin-style4', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/pricing-plan/pricing-skin-style4' . $direction_suffix . '.css' );
