<?php
namespace MascotCoreVentiq\Widgets\PricingPlan\Skins;
...
class Skin_Pricing_Style2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Pricing Style2', 'mascot-core-ventiq' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Title Head Section Options', 'mascot-core-ventiq' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Head Background', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Head BG Theme Colored", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Head BG Theme Colored (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			'wrapper_padding',
			[
				'label' => esc_html__( 'Head Padding', 'mascot-core-ventiq' ),
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-pricing-skin-style2', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/pricing-plan/pricing-skin-style2' . $direction_suffix . '.css' );
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'pricing-plan', $settings['_skin'], 'pricing-plan/tpl', $settings, true );
