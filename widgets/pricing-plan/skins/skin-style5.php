...
class Skin_Pricing_Style5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Pricing Style5', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-pricing-skin-style5', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/pricing-plan/pricing-skin-style5' . $direction_suffix . '.css' );
		wp_register_script( 'pricing-skin-style5', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/pricing-skin-style5.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'pricing-skin-style5' );
