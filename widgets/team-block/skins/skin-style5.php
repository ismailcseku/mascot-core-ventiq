...
class Skin_Style5 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'team-block-style5', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/team-block/team-block-style5' . $direction_suffix . '.css' );

		wp_register_script( 'team-block-style4', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/team-block4.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'team-block-style4' );
