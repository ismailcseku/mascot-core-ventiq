<?php
namespace MascotCoreVentiq\Widgets\MovingTextRepeater;
...
class TM_Elementor_MovingTextRepeater extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-moving-text-repeater', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/moving-text-repeater/moving-text-repeater' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Moving Text Repeater', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'moving_text_options', [
				'label' => esc_html__( 'Moving Text Items', 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'text',
			[
				'label' => esc_html__( "Moving Text", 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'divider_text',
			[
				'label' => esc_html__( "Divider Symbol/Text", 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'divider_icon',
			[
				'label' => __('Or Divider Icon', 'mascot-core-ventiq'),
		...
		$this->add_control(
			'moving_texts_array',
			[
				'label' => esc_html__( "Moving Texts", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'text' => esc_html__( 'Text #1', 'mascot-core-ventiq' ),
					],
					[
						'text' => esc_html__( 'Text #2', 'mascot-core-ventiq' ),
					],
					[
						'text' => esc_html__( 'Text #3', 'mascot-core-ventiq' ),
					],
				],
			]
		);
		...
		$this->add_control(
			'moving_direction', [
				'label' => esc_html__( "Moving Direction", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'text_rotate',
			[
				'label' => esc_html__( 'Rotate Text', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'animation_speed',
			[
				'label' => esc_html__( 'Animation Duration(High-Low)', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mouseover Text Fill Animation', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Text Fill Color', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Text Fill Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_control(
			'text_color_normal',
			[
				'label' => esc_html__( 'Fill Color', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::COLOR,
		...
		$this->add_control(
			'text_theme_colored',
			[
				'label' => esc_html__( "Fill Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_tab(
			'text_even_item',
			[
				'label' => esc_html__( 'Even Item', 'mascot-core-ventiq' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Divider Styling', 'mascot-core-ventiq' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			'divider_even',
			[
				'label' => esc_html__( 'Even', 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'divider_fill_even',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Divider BG Image', 'mascot-core-ventiq' ),
