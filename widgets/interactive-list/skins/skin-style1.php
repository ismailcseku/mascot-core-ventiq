<?php
namespace MascotCoreVentiq\Widgets\InteractiveList\Skins;
...
class Skin_Style1 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'interactive-list-' . $settings['_skin'], null, 'interactive-list/tpl', $settings, true );
