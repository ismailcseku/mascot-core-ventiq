...
<div class="service-block-cursor-floating-info tm-floating-info-item">
  <div class="inner-box">
    ...
    <div class="content-box">
      <div class="info-box">
        <div class="floating-title"><?php mascot_core_ventiq_get_shortcode_template_part( 'part-title', null, 'service-block/tpl', $service_item, false );?></div>
        <div class="floating-subtitle"><?php mascot_core_ventiq_get_shortcode_template_part( 'part-subtitle', null, 'service-block/tpl', $service_item, false );?></div>
      </div>
    </div>
  </div>
</div>