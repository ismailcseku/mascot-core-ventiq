...
class Skin_Style11 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style11', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/service-block/service-block-style11' . $direction_suffix . '.css' );

		wp_enqueue_script( 'tm-service-block-style11', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/service-block11.js', array( 'jquery' ), false, true );
