...
class Skin_Style1 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .service-block-style1 .inner-box .content-box' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-block-style1 .inner-box .content-box' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
	...
	public function render() {
		...
		wp_register_script( 'jquery-service-block', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/service-block.js', array( 'jquery' ), false, true );
