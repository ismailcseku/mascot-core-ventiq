...
class Skin_Style8 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style8', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/service-block/service-block-style8' . $direction_suffix . '.css' );
		wp_enqueue_script( 'tm-service-block-bg-image', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/service-block-bg-image.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'tm-service-block-item8-active', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/service-block-item8-active.js', array( 'jquery' ), false, true );
