...
class Skin_Creative1 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Creative 1', 'mascot-core-ventiq' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Link Color Options', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Each Item Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-creative1', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/service-block/service-block-creative1' . $direction_suffix . '.css' );
		wp_register_script( 'service-block-creative1', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/service-block-creative1.js', array( 'jquery' ), false, true );
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'service-item', $settings['_skin'], 'service-block/tpl', $settings, true );
