...
class Skin_Style15 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style15', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style15', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/service-block/service-block-style15' . $direction_suffix . '.css' );
