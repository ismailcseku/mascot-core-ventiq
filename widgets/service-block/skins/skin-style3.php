...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .service-block-style3',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .service-block-style3' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style3', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/service-block/service-block-style3' . $direction_suffix . '.css' );
		wp_enqueue_script( 'service-block-style3', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/service-block3.js', array('jquery'), false, true );
