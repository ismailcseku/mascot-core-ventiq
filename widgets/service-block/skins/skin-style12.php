...
class Skin_Style12 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style12', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/service-block/service-block-style12' . $direction_suffix . '.css' );
		wp_register_script( 'service-block-style12', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/service-block12.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'service-block-style12' );
