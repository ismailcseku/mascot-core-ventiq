...
?>
<div class="counter-block-style5 mascot-counter <?php echo esc_attr($animation);?>" data-wow-delay="<?php echo esc_attr($animation_delay);?>">
	<div class="inner-box">
		<div class="icon-box">
			<?php if ( $show_icon_image == 'yes' ): ?>
				<?php mascot_core_ventiq_get_shortcode_template_part( 'icon-type', $icon_type, 'counter-block/tpl', $settings, false );?>
			<?php endif;?>
		</div>
