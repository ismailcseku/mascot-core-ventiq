<?php
namespace MascotCoreVentiq\Widgets\CounterBlock;
...
class TM_Elementor_CounterBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-counter-block-loader', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Funfact Counter (Ventiq)', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'counter_position',
			[
				'label' => esc_html__( "Counter Positioning", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'default' => esc_html__( 'Icon - Title - Counter', 'mascot-core-ventiq' ),
					'icon_counter_title' => esc_html__( 'Icon - Counter - Title', 'mascot-core-ventiq' ),
				],
		...
		$this->start_controls_section(
			'counter_options',
			[
				'label' => esc_html__( 'Counter Value', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'counter_range',
			[
				'label' => esc_html__( "Counting Value/Number", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'description'	=> esc_html__( 'Enter number for counter without any special character. Default: 1250', 'mascot-core-ventiq' ),
				'default' => esc_html__( "1250", 'mascot-core-ventiq' )
			]
		);
		$this->add_control(
			'counter_prefix',
			[
				'label' => esc_html__( "Counting Value Prefix", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'description' => esc_html__( "Add an Unit Symbol to the Right of Percent Value", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'counter_postfix',
			[
				'label' => esc_html__( "Counting Value Postfix", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$this->add_control(
			'counter_duration',
			[
				'label' => esc_html__( "Counter Duration(ms)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'description'	=> esc_html__( 'Default: 1500', 'mascot-core-ventiq' ),
				'default' => '1500'
			]
		);
		$this->add_control(
			'counter_tag',
			[
				'label'   => esc_html__( 'Counter Tag', 'mascot-core-ventiq' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'no',
		...
		$this->add_responsive_control(
			'subtitle_show',
			[
				'label' => esc_html__( 'Show/Hide Sub Title', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Sub Title", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( "Subtitle Here", 'mascot-core-ventiq' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Custom CSS Class", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Image Custom Width (Only number)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "Put custom width of the uploaded image in positive integer value. Example: 120", 'mascot-core-ventiq' ),
				'condition' => [
					'icon_type' => array('image')
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::MEDIA,
				"description" => esc_html__( "Upload Icon Bg image", 'mascot-core-ventiq' ),
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Icon Horizontal Alignment(Flex)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Icon Vertical Alignment(Flex)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon/Image Area BG Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .counter-icon' => 'background-color: var(--theme-color{{VALUE}});',
				],
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon/Image Area Custom BG Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon/Image Area BG Theme Colored (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
					'{{WRAPPER}}:hover .counter-icon' => 'background-color: var(--theme-color{{VALUE}});',
				],
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon/Image Area Custom BG Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .counter-block:hover .counter-icon' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->end_controls_tab();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Counter Value Styling', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Counter Custom CSS Class", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .mascot-counter .counter' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .mascot-counter .counter' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'mascot-core-ventiq' ),
				'selector' => '{{WRAPPER}} .mascot-counter .counter',
			]
		);
		$this->add_responsive_control(
			'counter_margin',
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .mascot-counter .counter' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .mascot-counter .counter' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}:hover .mascot-counter .counter' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}}:hover .mascot-counter .counter' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .mascot-counter .counter:hover' => 'color: {{VALUE}};',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .mascot-counter .counter:hover' => 'color: var(--theme-color{{VALUE}});',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Subtitle Custom CSS Class", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Counter Wrapper Style', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'show_icon_image',
			[
				'label' => esc_html__( "Show Icon/Image", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'show_counter',
			[
				'label' => esc_html__( "Show Counter", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'tm-counter-block-style1', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-style1' . $direction_suffix . '.css' );
		...
		$settings['animation_duration'] = mascot_core_ventiq_get_inline_attributes( $settings['counter_duration'], 'data-animation-duration' );
		...
		wp_register_script( 'jquery-animatenumbers', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/plugins/jquery.animatenumbers.min.js', array( 'jquery' ), false, true );
		wp_register_script( 'funfact-animate-number', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/funfact-animate-number.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'jquery-animatenumbers' );
		wp_enqueue_script( 'funfact-animate-number' );
		$settings['settings'] = $settings;

		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = mascot_core_ventiq_get_shortcode_template_part( 'counter-skin-style1', null, 'counter-block/tpl', $settings, true );
