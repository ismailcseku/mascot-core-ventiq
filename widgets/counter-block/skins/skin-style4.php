...
class Skin_Style4 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-counter-block-style4', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-style4' . $direction_suffix . '.css' );
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'counter-skin-style4', null, 'counter-block/tpl', $settings, true );
