...
class TM_Elementor_App_Button extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-app-button', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/app-button' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'TM - App Button', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "Download on the", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'title',
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "App Store", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'link',
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'app-button', null, 'app-button/tpl', $settings, true );
