...
class Skin_Side_Push_Panel extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Side Push Panel Icon', 'mascot-core-ventiq' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			'post_id', [
				'label' => esc_html__( "Side Panel Content", 'mascot-core-ventiq' ),
	...
	public function register_layout_controls_two( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'icon_options',
			[
				'label' => esc_html__( 'Side Push Panel Hamburger Icon Options', 'mascot-core-ventiq' ),
