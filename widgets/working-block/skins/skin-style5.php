...
class Skin_Style5 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-working-block-style5', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/working-block/working-block-style5' . $direction_suffix . '.css' );
		wp_enqueue_script( 'tm-working-steps-bg-image', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/working-steps-bg-image.js', array( 'jquery' ), false, true );
