...
?>
<div class="working-block-style3 <?php echo esc_html( $working_item['show_reverse_position'] ); ?>">
  <div class="work-item">
    <div class="icon">
    ...
    <div class="line">
      <?php mascot_core_ventiq_get_shortcode_template_part( 'featured-image', null, 'working-block/tpl', $working_item, false );?>
    </div>
  </div>
</div>