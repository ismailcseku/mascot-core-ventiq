...
<?php if ( $working_block_items_array ) : ?>
	<div class="tm-sc-working tm-working-grid tm-sc-working-<?php echo esc_attr( $settings['_skin'] ); ?>">
		...
		<div id="<?php echo esc_attr( $holder_id ) ?>" class="isotope-layout grid-<?php echo esc_attr( $columns ); ?> <?php echo esc_attr( $gutter );?> clearfix">
			<div class="isotope-layout-inner">
				...
				<div class="isotope-item working-block elementor-repeater-item-<?php echo $working_item['_id']; ?> <?php echo esc_attr($animation);?>" data-wow-delay="<?php echo esc_attr($animation_delay);?>">
					<?php mascot_core_ventiq_get_shortcode_template_part( 'working-block-item', $_skin, 'working-block/tpl', $settings, false ); ?>
				</div>
				<?php } ?>
				<!-- end of the loop -->
			</div>
