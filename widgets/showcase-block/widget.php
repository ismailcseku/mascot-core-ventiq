<?php
namespace MascotCoreVentiq\Widgets\ShowcaseBlock;
...
class TM_Elementor_ShowcaseBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-showcase-block', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/showcase-block' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Showcase Block', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'service_icons_options', [
				'label' => esc_html__( 'Showcase Items', 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'btn1_text',
			[
				'label' => esc_html__( "Button 1 Text", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "View Demo", 'mascot-core-ventiq' ),
			]
		);
		$repeater->add_control(
			'btn1_link',
			[
				'label' => esc_html__( "Button 1 Link URL", 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'btn2_text',
			[
				'label' => esc_html__( "Button 2 Text", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "View Demo", 'mascot-core-ventiq' ),
			]
		);
		$repeater->add_control(
			'btn2_link',
			[
				'label' => esc_html__( "Button 2 Link URL", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::URL,
				'show_external' => true,
				'default' => [
					'url' => '',
			...
			[
				...
				'default' => [
					[
						...
						'btn1_text' => esc_html__( 'View Demo', 'mascot-core-ventiq' ),
						'btn2_text' => esc_html__( 'One Page', 'mascot-core-ventiq' ),
					],
					[
	...
	protected function render() {
		...
		$settings['holder_id'] = ventiq_get_isotope_holder_ID('showcase-block');

		$settings['settings'] = $settings;


		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = mascot_core_ventiq_get_shortcode_template_part( 'showcase', $settings['display_type'], 'showcase-block/tpl', $settings, true );
