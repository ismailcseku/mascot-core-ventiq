...
class TM_Elementor_Circle_Text extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-circle-text', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/circle-text' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'TM - Circle Text', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'circle_text_title',
			[
				'label' => esc_html__( "Circle Text", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__( "Welcome to our website", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'center_content_type',
			[
				'label' => esc_html__( "Center Content Type", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'icon',
				'options' => [
					'text' => esc_html__( 'Inner Text', 'mascot-core-ventiq' ),
					'video' => esc_html__( 'Video Popup', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'inner_text',
			[
				'label' => esc_html__( "Inner Text", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'condition' => [
		...
		$this->add_control(
			'popup_video_url',
			[
				'label' => esc_html__( "Play Video URL", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_url( 'https://www.youtube.com/watch?v=K1QICrgxTjA', 'mascot-core-ventiq' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				"description" => esc_html__( "Upload the center thumbnail image", 'mascot-core-ventiq' ),
				'condition' => [
		...
		$this->add_responsive_control(
			'svg_width',
			[
				'label' => esc_html__( 'Box Width', 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			'circle_text_section',
			[
				'label' => esc_html__( 'Circle Text Options', 'mascot-core-ventiq' ),
	...
	$this->start_controls_section(
		'inner_text_section',
		[
			'label' => esc_html__( 'Inner Text Options', 'mascot-core-ventiq' ),
			'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			'condition' => [
				'center_content_type' => 'text',
			],
	...
	$this->start_controls_section(
		'video_icon_section',
		[
			'label' => esc_html__( 'Video Icon Options', 'mascot-core-ventiq' ),
			'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			'condition' => [
				'center_content_type' => 'video',
			],
	...
	$this->start_controls_section(
		...
		$this->add_responsive_control(
			'img_object_fit',
			[
				'label' => esc_html__( 'Object Fit', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'cover',
				'options' => [
					'fill' => esc_html__( 'Fill', 'mascot-core-ventiq' ),
					'contain' => esc_html__( 'Contain', 'mascot-core-ventiq' ),
					'cover' => esc_html__( 'Cover', 'mascot-core-ventiq' ),
					'none' => esc_html__( 'None', 'mascot-core-ventiq' ),
					'scale-down' => esc_html__( 'Scale Down', 'mascot-core-ventiq' ),
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			'img_object_position',
			[
				'label' => esc_html__( 'Object Position', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'center center',
				'options' => [
					'center center' => esc_html__( 'Center Center', 'mascot-core-ventiq' ),
					'center left' => esc_html__( 'Center Left', 'mascot-core-ventiq' ),
					'center right' => esc_html__( 'Center Right', 'mascot-core-ventiq' ),
					'top center' => esc_html__( 'Top Center', 'mascot-core-ventiq' ),
					'top left' => esc_html__( 'Top Left', 'mascot-core-ventiq' ),
					'top right' => esc_html__( 'Top Right', 'mascot-core-ventiq' ),
					'bottom center' => esc_html__( 'Bottom Center', 'mascot-core-ventiq' ),
					'bottom left' => esc_html__( 'Bottom Left', 'mascot-core-ventiq' ),
					'bottom right' => esc_html__( 'Bottom Right', 'mascot-core-ventiq' ),
				],
				'selectors' => [
		...
		$this->start_controls_section(
			'icon_bg_options',
			[
				'label' => esc_html__( 'Icon Background Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'icon_bg_size',
			[
				'label' => esc_html__( 'Size (Width & Height)', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'unit' => 'px',
				],
		...
		$this->add_responsive_control(
			'icon_bg_blur',
			[
				'label' => esc_html__( 'Background Blur', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'circle-text', null, 'circle-text/tpl', $settings, true );
