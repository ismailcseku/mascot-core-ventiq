...
<?php
	//Swiper Slider Data
	$swiper_slide_data_info = mascot_core_ventiq_swiper_data_params( $settings );
?>
		...
		<div class="swiper-container-inner">
			<div class="swiper-wrapper">
				...
				<?php foreach (  $hero_slider_items_array as $hero_slider_item ) { ?>
					...
					?>
					<div class="swiper-slide elementor-repeater-item-<?php echo $hero_slider_item['_id']; ?> <?php echo esc_attr($animation);?>" data-wow-delay="<?php echo esc_attr($animation_delay);?>">
						<?php mascot_core_ventiq_get_shortcode_template_part( 'slider-item', $_skin, 'hero-slider/tpl', $settings, false ); ?>
					</div>
				<?php } ?>
				<!-- end of the loop -->
			</div>
			...
			<div class="swiper swiper-item-wrap tm-hero-slider-thumb">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<?php mascot_core_ventiq_get_shortcode_template_part( 'slider-item-thumb', $_skin, 'hero-slider/tpl', $settings, false ); ?>
					</div>
					<?php } ?>
					<!-- end of the loop -->
				</div>
...
<?php else : ?>
	<?php mascot_core_ventiq_no_posts_match_criteria_text(); ?>
<?php endif; ?>