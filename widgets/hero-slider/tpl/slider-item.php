    ...
    <div class="e-con-inner">
      <div class="content-wrap">
        <div class="slider-content">
          <?php mascot_core_ventiq_get_shortcode_template_part( 'part-subtitle', null, 'hero-slider/tpl', $hero_slider_item, false );?>
          ...
          <?php mascot_core_ventiq_get_shortcode_template_part( 'button', null, 'hero-slider/tpl', $hero_slider_item, false );?>
        </div>
      </div>
    </div>
  </div>
