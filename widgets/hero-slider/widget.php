<?php
namespace MascotCoreVentiq\Widgets\HeroSlider;
...
class TM_Elementor_HeroSlider extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-hero-slider-loader', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/hero-slider/hero-slider-loader' . $direction_suffix . '.css' );
		}

		wp_enqueue_style( 'swiper' );
		wp_enqueue_script( 'swiper' );
		wp_register_script( 'tm-hero-slider', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/hero-slider.js', array('jquery'), false, true );
	...
	public function get_title() {
		return esc_html__( 'TM Hero Slider', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'hero_slider_options', [
				'label' => esc_html__( 'Hero Items', 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'link_text',
			[
				'label' => esc_html__( "Link Text", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Hero Slider Items", 'mascot-core-ventiq' ),
				...
				'default' => [
					...
					[
						...
						'subtitle' => esc_html__( 'Subtitle #2', 'mascot-core-ventiq' ),
						'featured_image' => Utils::get_placeholder_image_src(),
						'content' => esc_html__( 'Item content. Click the edit button to change this text.', 'mascot-core-ventiq' ),
					],
					[
						'title' => esc_html__( 'Title #3', 'mascot-core-ventiq' ),
						'subtitle' => esc_html__( 'Subtitle #3', 'mascot-core-ventiq' ),
						'featured_image' => Utils::get_placeholder_image_src(),
						'content' => esc_html__( 'Item content. Click the edit button to change this text.', 'mascot-core-ventiq' ),
					],
				],
		...
		$this->start_controls_section(
			'tm_animation',
			[
				'label' => esc_html__( 'Slider Default Settings', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'slider_animation', [
				'label'        => __( 'Slider Animation', 'mascot-core-ventiq' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', 'mascot-core-ventiq' ),
				'label_off'    => __( 'Hide', 'mascot-core-ventiq' ),
				'default'      => 'yes',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'label'   => esc_html__( 'Slider Content Width', 'mascot-core-ventiq' ),
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'slider_padding',
			[
				'label'      => __( 'Slider Padding', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'show_subtitle', [
				'label' => esc_html__( "Show Subtitle", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			'show_button', [
				'label' => esc_html__( "Show Button", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'show_thumb', [
				'label'        => __( 'Show Thumb', 'mascot-core-ventiq' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', 'mascot-core-ventiq' ),
				'label_off'    => __( 'Hide', 'mascot-core-ventiq' ),
				'default'      => 'yes',
		...
		$this->add_control(
			'show_thumb_img', [
				'label' => esc_html__( "Show Thumb Image", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition'   => [
						'show_thumb' => [ 'yes' ]
		...
		$this->add_control(
			'show_thumb_title', [
				'label' => esc_html__( "Show Thumb Text", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition'   => [
						'show_thumb' => [ 'yes' ]
		...
		$this->add_responsive_control(
			'content_alignment',
			[
				'label' => esc_html__( "Content Alignment", 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			'thumb_alignment',
			[
				'label' => esc_html__( "Thumb Alignment", 'mascot-core-ventiq' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => mascot_core_ventiq_text_align_choose(),
				'selectors' => [
		...
		$this->start_controls_section(
			'tm_thumb_settings',
			[
				'label' => esc_html__( 'Thumb Settings', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				'type'    => Controls_Manager::SLIDER,
				'label'   => esc_html__( 'Thumb Wrapper Width', 'mascot-core-ventiq' ),
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				'type'    => Controls_Manager::SLIDER,
				'label'   => esc_html__( 'Thumb Height', 'mascot-core-ventiq' ),
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'thumb_margin',
			[
				'label'      => __( 'Thumb Box Margin', 'mascot-core-ventiq' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'thumb_padding',
			[
				'label'      => __( 'Thumb Box Padding', 'mascot-core-ventiq' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Image Overlay  Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Thumb Title Styling', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
