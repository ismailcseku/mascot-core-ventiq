...
class TM_Elementor_Spin_Text_Around_Logo extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-spin-text-around-logo', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/spin-text-around-logo' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Spin Text Around Logo', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'spin_image',
			[
				'label' => esc_html__( "Spin Image", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'text',
			[
				'label' => esc_html__( "Text in Center", 'mascot-core-ventiq' ),
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'spin-text-around-logo', null, 'spin-text-around-logo/tpl', $settings, true );
