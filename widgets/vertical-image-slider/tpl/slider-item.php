...
if (!empty($slider_item['link']['url'])) {
	...
	$link_nofollow = !empty($slider_item['link']['nofollow']) ? 'rel="nofollow"' : '';
}
...
<div class="tm-vertical-image-slider-item">
	<div class="slider-image">
		<?php if (!empty($link_url)) : ?>
			<a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>" <?php echo $link_nofollow; ?>>
				<?php echo $image_html; ?>
			</a>
		<?php else : ?>
			<?php echo $image_html; ?>
