<?php
namespace MascotCoreVentiq\Widgets\CountdownTimer;
...
class TM_Elementor_Countdown_Timer extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'jquery-countdown', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/plugins/jquery.countdown.min.js', array('jquery'), false, true );
		wp_register_script( 'jquery-final-countdown', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/plugins/jquery.final-countdown.min.js', array('jquery'), false, true );
		wp_register_script( 'kinetic', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/plugins/kinetic.js', array('jquery'), false, true );

		$direction_suffix = is_rtl() ? '.rtl' : '';


		wp_register_script( 'tm-countdown-timer-current-style-script', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/countdown-timer.js' );


		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			$direction_suffix = is_rtl() ? '.rtl' : '';
			wp_enqueue_style( 'tm-countdown-timer-loader', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/countdown-timer/countdown-timer-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Countdown Timer (Ventiq)', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Future Ending Date & Time (Format Y/m/d H:i:s)", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'show_time',
			[
				'label' => esc_html__( "Show Time?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'mascot-core-ventiq' ),
				'label_off' => esc_html__( 'No', 'mascot-core-ventiq' ),
				'return_value' => 'yes',
				'default' => 'yes',
				'description' => esc_html__( "Show or Hide Time of the date", 'mascot-core-ventiq' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Block Horizontal Alignment(Flex)", 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			'Word_options',
			[
				'label' => esc_html__( 'Word Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'word_month',
			[
				'label' => esc_html__( "Word - Month", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'word_week',
			[
				'label' => esc_html__( "Word - Week", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'weeks'
			]
		);
		$this->add_control(
			'word_day',
			[
				'label' => esc_html__( "Word - Day", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'days'
			]
		);
		$this->add_control(
			'word_hr',
			[
				'label' => esc_html__( "Word - Hour", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'hr'
			]
		);
		$this->add_control(
			'word_min',
			[
				'label' => esc_html__( "Word - Minute", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'min'
			]
		);
		$this->add_control(
			'word_sec',
			[
				'label' => esc_html__( "Word - Second", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'sec'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Counter Label Styling', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Counter Block', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'tpl-default', null, 'countdown-timer/tpl', $settings, true );
