<?php
namespace MascotCoreVentiq\Widgets\ThemeButton;
...
class TM_Elementor_Theme_Button extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-theme-button-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/theme-button/theme-button-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Theme Button - Ventiq', 'mascot-core-ventiq' );
	}
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'tm-theme-button-style1', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/theme-button/theme-button-style1' . $direction_suffix . '.css' );
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'theme-button-skin-default', null, 'theme-button/tpl', $settings, true );
