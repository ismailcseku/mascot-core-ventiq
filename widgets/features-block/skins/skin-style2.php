...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			'featured_image',
			[
				'label' => __('Background Images', 'mascot-core-ventiq'),
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-features-block-style2', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/features-block/features-block-style2' . $direction_suffix . '.css' );
