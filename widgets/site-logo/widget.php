...
class TM_Elementor_Site_Logo extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Site Logo', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'logo_type',
			[
				'label' => esc_html__( "Logo Type", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'logo-default' => esc_html__( 'Logo (Default)', 'mascot-core-ventiq' ),
					'logo-white' => esc_html__( 'Logo (White) For Dark Background', 'mascot-core-ventiq' ),
				],
		...
		$this->add_responsive_control(
			'site_logo_alignment',
			[
				'label' => esc_html__( "Logo Alignment", 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			'logo_margin',
			[
				'label' => esc_html__( 'Logo Margin', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'logo_filter_options',
			[
				'label' => esc_html__( 'Logo Filter Options', 'mascot-core-ventiq' ),
	...
	protected function render() {
		...
		// do_action( 'ventiq_header_logo' );

		$logo_url = array();

		$use_logo = ventiq_get_redux_option( 'logo-settings-want-to-use-logo', false );
		$site_brand = esc_html( ventiq_get_redux_option( 'logo-settings-site-brand', get_bloginfo( 'name' ) ) );
		$use_switchable_logo = ventiq_get_redux_option( 'logo-settings-switchable-logo' );

		if ( $settings['logo_type'] == 'logo-default' ) {
			$logo_default = ventiq_get_redux_option( 'logo-settings-logo-default' );
		} else {
			$logo_default = ventiq_get_redux_option( 'logo-settings-logo-default-dark-bg' );
		}

		if( $use_switchable_logo ) {
			$logo_light = esc_url( ventiq_get_redux_option( 'logo-settings-logo-primary', false, 'url' ) );
			$logo_dark = esc_url( ventiq_get_redux_option( 'logo-settings-logo-on-sticky', false, 'url' ) );
		}
