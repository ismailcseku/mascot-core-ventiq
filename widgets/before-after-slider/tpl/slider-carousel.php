		...
		<div class="swiper-container-inner">
			<div class="swiper-wrapper">
				...
				<?php foreach (  $slider_items_array as $slider_items ) { ?>
					...
					<div class="swiper-slide elementor-repeater-item-<?php echo $slider_items['_id']; ?>">
						<?php mascot_core_ventiq_get_shortcode_template_part( 'before-after-slider', null, 'before-after-slider/tpl', $settings, false ); ?>
					</div>
				<?php } ?>
				<!-- end of the loop -->
			</div>
