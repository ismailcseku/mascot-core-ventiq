...
class TM_Elementor_Projects_Pre_Next extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-projects-pre-next', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/projects-pre-next' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'TM - Projects Pre Next', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'icon_border_color',
			[
				'label' => esc_html__( "Right Border Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'projects-pre-next', null, 'projects-pre-next/tpl', $settings, true );
