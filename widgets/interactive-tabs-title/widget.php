<?php
namespace MascotCoreVentiq\Widgets\InteractiveTabs;
...
class TM_Elementor_InteractiveTabsTitle extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-interactive-tabs', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/interactive-tabs/interactive-tabs-loader' . $direction_suffix . '.css' );

		wp_register_script( 'tm-interactive-tabs', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/interactive-tabs.js', array('jquery'), false, true );
	}
	...
	public function get_title() {
		return esc_html__( 'Interactive Tabs - Title', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Slave Tab Content ID', 'mascot-core-ventiq'),
		...
		$this->add_control(
			'list_items',
			[
				'label'		  => esc_html__( 'Tab Title List', 'mascot-core-ventiq' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'title' => esc_html__('Creative', 'mascot-core-ventiq'),
						'activate' => 'yes',
					],
					[
						'title' => esc_html__('Agency', 'mascot-core-ventiq'),
					]
				],
				'title_field' => '{{{ title }}}',
			]
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Hover/Active', 'mascot-core-ventiq'),
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Text Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Custom BG Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'interactive-tabs-title-default', null, 'interactive-tabs-title/tpl', $settings, true );
