<?php
namespace MascotCoreVentiq\Widgets\PricingBlock\Skins;
...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'pricing-block-style3', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/pricing-block/pricing-block-style3' . $direction_suffix . '.css' );
