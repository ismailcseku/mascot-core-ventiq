...
class Skin_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-skin-style-current-theme1', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/image-gallery/skin-style-current-theme1' . $direction_suffix . '.css' );
