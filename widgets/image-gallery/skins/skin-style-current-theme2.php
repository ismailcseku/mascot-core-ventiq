...
class Skin_Style_Current_Theme2 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-skin-style-current-theme2', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/image-gallery/skin-style-current-theme2' . $direction_suffix . '.css' );
