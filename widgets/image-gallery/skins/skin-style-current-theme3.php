<?php
namespace MascotCoreVentiq\Widgets\ImageGallery\Skins;
...
class Skin_Style_Current_Theme3 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-skin-style-current-theme3', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/image-gallery/skin-style-current-theme3' . $direction_suffix . '.css' );
