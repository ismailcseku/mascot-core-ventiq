...
<div class="tm-image-gallery tm-gallery-item-currenty-style2">
	<div class="inner-box">
		...
		<div class="info-box">
			<?php mascot_core_ventiq_get_shortcode_template_part( 'part-title', null, 'image-gallery/tpl', $gallery_item, false );?>
			<?php mascot_core_ventiq_get_shortcode_template_part( 'part-subtitle', null, 'image-gallery/tpl', $gallery_item, false );?>
		</div>
	</div>
</div>