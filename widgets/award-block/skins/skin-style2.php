<?php
namespace MascotCoreVentiq\Widgets\AwardBlock\Skins;
...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-award-block-skin-style2', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/award-block/award-block-skin-style2' . $direction_suffix . '.css' );
