...
class TM_Elementor_InteractiveTabsContent extends Widget_Base {
    public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-interactive-tabs-content', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/interactive-tabs/interactive-tabs-content' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'Interactive Tabs - Content', 'mascot-core-ventiq' );
	}
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'interactive-tabs-content-style1', null, 'interactive-tabs-content/tpl', $settings, true );
