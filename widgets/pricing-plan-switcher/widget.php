<?php
namespace MascotCoreVentiq\Widgets\PricingPlanSwitcher;
...
class TM_Elementor_Pricing_Plan_Switcher extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'tm-pricing-plan-switcher', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/pricing-plan-switcher.js', array('jquery'), false, true );

		wp_register_style( 'tm-pricing-plan-switcher', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/pricing-plan/pricing-switcher' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Pricing Plan Switcher - Ventiq', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'tm_general',
			[
				'label' => esc_html__( 'Switcher Variants', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Default Variant Name", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Monthly", 'mascot-core-ventiq' ),
				"description" => esc_html__( "Enter the default switcher variant name", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'variant_text_secondary',
			[
				'label' => esc_html__( "Secondary Variant Name", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Yearly", 'mascot-core-ventiq' ),
				"description" => esc_html__( "Enter the secondary switcher variant name", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'variant_text_offer',
			[
				'label' => esc_html__( "Offer Text", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "20% Off", 'mascot-core-ventiq' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Default Variant Options', 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Secondary Variant Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Offer Text Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Text Background Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Text BG Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Bullet Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Background Color (Active)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Background Theme Colored (Active)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'switcher-skin-style1', null, 'pricing-plan-switcher/tpl', $settings, true );
