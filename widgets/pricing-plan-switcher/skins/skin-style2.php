...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'default_options',
			[
				'label' => esc_html__( 'Default Settings', 'mascot-core-ventiq' ),
        ...
        $this->add_control(
            'round_button',
            [
                'label' => esc_html__( 'Round Button', 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button Active/Hover Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
