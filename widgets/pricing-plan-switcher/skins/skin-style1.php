<?php
namespace MascotCoreVentiq\Widgets\PricingPlanSwitcher\Skins;
...
class Skin_Style1 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_template_part( 'switcher', $settings['_skin'], 'pricing-plan-switcher/tpl', $settings, true );
