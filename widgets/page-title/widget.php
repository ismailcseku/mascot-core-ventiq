...
class TM_Elementor_Page_Title extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Page Title', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'item_type', [
				'label' => esc_html__( "Choose Item", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'title' => esc_html__( 'Title', 'mascot-core-ventiq' ),
					'breadcrumb' => esc_html__( 'Breadcrumb', 'mascot-core-ventiq' ),
					'subtitle' => esc_html__( 'Subtitle', 'mascot-core-ventiq' ),
				],
				'default' => 'title'
			]
		);
		...
		$this->start_controls_section(
			'breadcrumb_options',
			[
				'label' => esc_html__( 'Breadcrumb Items Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Breadcrumb Wrapper Global Border/Spacing', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
				'condition' => [
					'item_type' => array('breadcrumb')
				]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Color Option', 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Breadcrumb Last Child/Item Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
				'condition' => [
					'item_type' => array('breadcrumb')
				]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Breadcrumb Bullet/Icon Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
				'condition' => [
					'item_type' => array('breadcrumb')
				]
		...
		$this->add_control(
			'custom_bullet_icon',
			[
				'label' => esc_html__( 'Bullet Icon from Library', 'mascot-core-ventiq' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Bullet Typography', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Bullet Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Bullet Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
	...
	protected function render() {
		...
		switch ($settings['item_type']) {
			...
			case 'breadcrumb':
				...
				ventiq_display_breadcrumbs($icon_html);
				break;
			case 'subtitle':
				ventiq_get_title_area_subtitle();
				break;
			default:
				break;
		}
