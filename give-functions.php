...
function mascot_core_ventiq_goal_progress($form_id, $args) {
...
function mascot_core_ventiq_give_progress_bar($total_earnings, $total_goal) {
  // Total Earnings.
...
function mascot_core_ventiq_give_amount_formatted($amount) {
