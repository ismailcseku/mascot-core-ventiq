...
class Plugin {
	...
	public function widget_styles_frontend() {
		...
		wp_enqueue_style( 'tm-header-search', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/shortcodes/header-search' . $direction_suffix . '.css' );
		wp_enqueue_style( 'mascot-core-widgets-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/mascot-core-widgets-style' . $direction_suffix . '.css' );
	}
