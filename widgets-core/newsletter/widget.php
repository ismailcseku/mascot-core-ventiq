...
class TM_Elementor_Newsletter extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-newsletter-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/newsletter' . $direction_suffix . '.css' );
    }
    ...
    public function get_title() {
        return esc_html__( 'TM Mailchimp Newsletter', 'mascot-core-ventiq' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'mailchimp_form_id',
            [
                'label'       => esc_html__( 'Type Mailchimp Form ID', 'mascot-core-ventiq' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => '419',
                'description' => sprintf(__('To collect your Mailchimp Form ID <a href="%s" target="_blank">Click here</a>', 'mascot-core-ventiq'), admin_url('admin.php?page=mailchimp-for-wp-forms')),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'flat' => esc_html__( 'Flat', 'mascot-core-ventiq' ),
                    'classic' => esc_html__( 'Classic', 'mascot-core-ventiq' ),
                    'default' => esc_html__( 'Default', 'mascot-core-ventiq' ),
                    'round' => esc_html__( 'Round', 'mascot-core-ventiq' ),
                    'btn-absolute' => esc_html__( 'Absolute Button', 'mascot-core-ventiq' ),
                ],
                'default' => 'flat',
                'separator'   => 'before',
            ]
        ...
        $this->add_control(
            'form_style',
            [
                'label'        => esc_html__( 'Form Style Block', 'mascot-core-ventiq' ),
        ...
        $this->add_control(
            'heading_input',
            [
                'label' => esc_html__( 'Input', 'mascot-core-ventiq' ),
        ...
        $this->add_control(
            'text_hide',
            [
                'label'        => esc_html__( 'Hide Text', 'mascot-core-ventiq' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_off'    => esc_html__( 'Off', 'mascot-core-ventiq' ),
                'label_on'     => esc_html__( 'On', 'mascot-core-ventiq' ),
                'default'      => '',
        ...
        $this->add_control(
            'icon_hide',
            [
                'label'        => esc_html__( 'Hide Icon', 'mascot-core-ventiq' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_off'    => esc_html__( 'Off', 'mascot-core-ventiq' ),
                'label_on'     => esc_html__( 'On', 'mascot-core-ventiq' ),
                'default'      => '',
        ...
        $this->add_responsive_control(
            'icon_margin',
            [
                'label'      => esc_html__( 'Margin Icon', 'mascot-core-ventiq' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Input Field Style', 'mascot-core-ventiq' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Text Theme Color', 'mascot-core-ventiq'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_ventiq_theme_color_list(),
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'placeholder_color',
            [
                'label'     => esc_html__( 'Placeholder Color', 'mascot-core-ventiq' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Button Style', 'mascot-core-ventiq' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Border Theme Color', 'mascot-core-ventiq'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_ventiq_theme_color_list(),
                'default' => '',
                'selectors' => [
        ...
        // Switcher to enable/disable newsletter background gradient
        $this->add_control(
            'enable_newsletter_gradient',
            [
                'label'        => esc_html__( 'Enable Newsletter Background Gradient', 'mascot-core-ventiq' ),
        ...
        $this->add_responsive_control(
            'newsletter_background_gradient',
            [
                'label'     => esc_html__( 'Newsletter Background Gradient', 'mascot-core-ventiq' ),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'options'   => [
                    'linear-gradient(99deg, var(--theme-color1) 0%, var(--theme-color4) 93.92%)' => esc_html__( 'Gradient One', 'mascot-core-ventiq' ),
                    'linear-gradient(99deg, var(--theme-color2) 0%, var(--theme-color3) 93.92%)' => esc_html__( 'Gradient Two', 'mascot-core-ventiq' ),
                    'linear-gradient(99deg, var(--theme-color1) 0%, var(--theme-color4) 93.92%)' => esc_html__( 'Gradient Three', 'mascot-core-ventiq' ),
                ],
                'default'   => 'linear-gradient(99deg, var(--theme-color1) 0%, var(--theme-color4) 93.92%)',
                'selectors' => [
                    '{{WRAPPER}} .tm-mc4wp-newsletter [type="submit"]' => 'background: {{VALUE}};',
                ],
                'condition' => [
                    'enable_newsletter_gradient' => 'yes',
                ],
            ]
        );
        // 1. ON/OFF switch for newsletter background
        $this->add_control(
            'enable_newsletter_background',
            [
                'label'        => esc_html__( 'Enable Newsletter Background', 'mascot-core-ventiq' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'mascot-core-ventiq' ),
                'label_off'    => esc_html__( 'Off', 'mascot-core-ventiq' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'newsletter_bg_type',
            [
                'label'     => esc_html__( 'Newsletter Background Type', 'mascot-core-ventiq' ),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'default'   => 'solid',
                'options'   => [
                ...
                'condition' => [
                    'enable_newsletter_background' => 'yes',
                ],
            ]
        );
        ...
        $this->add_control(
            'newsletter_custom_bg_color',
            [
                'label'     => esc_html__( 'Newsletter BG Custom Color', 'mascot-core-ventiq' ),
        ...
        $this->add_group_control(
            ...
            [
                'name'      => 'newsletter_gradient_bg',
                'label'     => esc_html__( 'Newsletter Gradient Background', 'mascot-core-ventiq' ),
                'types'     => [ 'gradient' ],
                'selector'  => '{{WRAPPER}} .tm-mc4wp-newsletter [type="submit"]',
                'condition' => [
                    'enable_newsletter_background' => 'yes',
                    'newsletter_bg_type' => 'gradient',
                ],
            ]
        );
                    ...
                    try {
                        ...
                        if( isset($mailchimp_form_id) && $mailchimp_form_id != 0 ) {
                          echo do_shortcode('[mc4wp_form id="'. $mailchimp_form_id .'"]');
                            ...
                            esc_html_e('Please create a newsletter form from Mailchip plugin and collect your Mailchip Form ID', 'mascot-core-ventiq');
                        }
                    } catch (Exception $e) {
                        esc_html_e('Please create a newsletter form from Mailchip plugins', 'mascot-core-ventiq');
                    }
                }
            ?>
        </div>
