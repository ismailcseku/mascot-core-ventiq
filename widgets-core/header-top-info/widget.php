...
class TM_Elementor_Header_Top_Info extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Header Top Info', 'mascot-core-ventiq' );
	}
	...
	<?php
		if ( $settings['info_items'] ) {
			...
			foreach (  $settings['info_items'] as $item ) {
				...
				$html .= mascot_core_ventiq_get_widgetcore_template_part( 'header-top-info', null, 'header-top-info/tpl', $item, true );
			}
		}
		echo $html;
	?>    </ul>
