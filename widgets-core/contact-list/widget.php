...
class TM_Elementor_Contact_List extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-contact-list-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/contact-list' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'Contact List Widget', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'round' => esc_html__( 'Round Background', 'mascot-core-ventiq' ),
                ],
                'default' => 'flat'
            ]
        );
		$this->add_control(
			'label_disply_type',
			[
				'label' => esc_html__('Parent Display Property', 'mascot-core-ventiq'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'flex',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Childs Display Property', 'mascot-core-ventiq'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'flex',
				'options' => mascot_core_ventiq_disply_type_list_elementor(),
				'selectors' => [
		...
		$this->add_control(
			'info_items',
			[
				'label' => esc_html__( "Info Items", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'title' => esc_html__( "+1234567789", 'mascot-core-ventiq' ),
					],
					[
						'title' => esc_html__( "needhelp@company.com", 'mascot-core-ventiq' ),
					],
				]
			]
		);
		...
		$this->add_responsive_control(
			'icon_area_width',
			[
				'label' => esc_html__( "Icon Container Width", 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			'prefix_options',
			[
				'label' => esc_html__( 'Prefix Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'prefix_hide',
			[
				'label' => esc_html__( "Hide Prefix?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Prefix Typography', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'prefix_color',
			[
				'label' => esc_html__( "Prefix Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Prefix Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'prefix_margin',
			[
				'label' => esc_html__( 'Prefix Margin', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
		...
		$this->start_controls_section(
			'link_options',
			[
				'label' => esc_html__( 'Link Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Link Typography', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Link Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'link_theme_colored',
			[
				'label' => esc_html__( "Link Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Link Theme Colored (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			'list_item_options',
			[
				'label' => esc_html__( 'Item Styling Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
	...
	<?php
		if ( $settings['info_items'] ) {
			...
			foreach (  $settings['info_items'] as $item ) {
				...
				$html .= mascot_core_ventiq_get_widgetcore_template_part( 'contact-list', null, 'contact-list/tpl', $item, true );
			}
		}
		echo $html;
	?>    </ul>
