...
class TM_Elementor_Contact_Form_7 extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-contact-form-7-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/contact-form-7' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'Contact Form 7', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		if (!function_exists('wpcf7')) {
			$this->start_controls_section(
				'tm_global_warning',
				[
					'label' => esc_html__('Warning!', 'mascot-core-ventiq'),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'raw' => esc_html__('<strong>Contact Form 7</strong> is not installed/activated on your site. Please install and activate <strong>Contact Form 7</strong> first.', 'mascot-core-ventiq'),
			...
			$this->start_controls_section(
				'section_info_box',
				[
					'label' => esc_html__('Contact Form', 'mascot-core-ventiq'),
				]
			);
			$this->add_control(
				'contact_form_list',
				[
					'label' => esc_html__('Select Form', 'mascot-core-ventiq'),
					'type' => Controls_Manager::SELECT,
					'label_block' => true,
					'options' => mascot_core_ventiq_get_wpcf7_list(),
					'default' => '0',
				]
			);
			$this->add_control(
				'labels_switch',
				[
					'label' => esc_html__('Show Labels', 'mascot-core-ventiq'),
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
					'label_on' => esc_html__('Show', 'mascot-core-ventiq'),
					'label_off' => esc_html__('Hide', 'mascot-core-ventiq'),
					'return_value' => 'yes',
				]
			);
			$this->end_controls_section();
			...
			$this->add_control(
				'form_subtitle',
				[
					'label' => esc_html__('Form Sub Title', 'mascot-core-ventiq'),
					'type' => Controls_Manager::SWITCHER,
			...
			$this->add_control(
				'form_title',
				[
					'label' => esc_html__('Form Title', 'mascot-core-ventiq'),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__('On', 'mascot-core-ventiq'),
					'label_off' => esc_html__('Off', 'mascot-core-ventiq'),
					'return_value' => 'yes',
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__('Description', 'mascot-core-ventiq'),
				]
			);
			$this->add_control(
				'form_description',
				[
					'label' => esc_html__('Form Description', 'mascot-core-ventiq'),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__('On', 'mascot-core-ventiq'),
					'label_off' => esc_html__('Off', 'mascot-core-ventiq'),
					'return_value' => 'yes',
			...
			$this->start_controls_section(
				'section_errors',
				[
					'label' => esc_html__('Errors', 'mascot-core-ventiq'),
				]
			);
			...
			$this->add_control(
				'error_messages',
				[
					'label' => esc_html__('Error Messages', 'mascot-core-ventiq'),
					'type' => Controls_Manager::SELECT,
					'default' => 'show',
					'options' => [
						'show' => esc_html__('Show', 'mascot-core-ventiq'),
			...
			$this->add_control(
				'validation_errors',
				[
					'label' => esc_html__('Validation Errors', 'mascot-core-ventiq'),
					'type' => Controls_Manager::SELECT,
					'default' => 'show',
					'options' => [
						'show' => esc_html__('Show', 'mascot-core-ventiq'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Form Container', 'mascot-core-ventiq'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Alignment', 'mascot-core-ventiq'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'default' => [
						'title' => esc_html__('Default', 'mascot-core-ventiq'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Max Width', 'mascot-core-ventiq'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Padding', 'mascot-core-ventiq'),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Title & Description', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'heading_alignment',
			[
				'label' => esc_html__('Alignment', 'mascot-core-ventiq'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__('Left', 'mascot-core-ventiq'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Heading Wrapper Style', 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Wrapper Style', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Only Select/Dropdown Field', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Dropdown Arrow Color', 'mascot-core-ventiq'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Placeholder Text Color', 'mascot-core-ventiq'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Input, Select & Textarea', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Background Theme Color', 'mascot-core-ventiq'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			'text_indent',
			[
				'label' => esc_html__('Text Indent', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'input_width',
			[
				'label' => esc_html__('Input Width', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'input_height',
			[
				'label' => esc_html__('Input Height', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'textarea_width',
			[
				'label' => esc_html__('Textarea Width', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'textarea_height',
			[
				'label' => esc_html__('Textarea Height', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_tab(
			'tab_fields_focus',
			[
				'label' => esc_html__('Focus', 'mascot-core-ventiq'),
			]
		);
		...
		$this->start_controls_section(
			'section_label_style',
			[
				'label' => esc_html__('Labels', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'labels_switch' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'raw' => esc_html__('if label spacing doesn\'t worked, please update label display', 'mascot-core-ventiq'),
				'content_classes' => 'tm-warning',
			]
		);
		$this->add_control(
			'label_disply_type',
			[
				'label' => esc_html__('Display', 'mascot-core-ventiq'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
				'options' => mascot_core_ventiq_disply_type_list_elementor(),
				'selectors' => [
		...
		$this->add_responsive_control(
			'label_spacing',
			[
				'label' => esc_html__('Spacing', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Placeholder', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'placeholder_switch',
			[
				'label' => esc_html__('Show Placeholder', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Radio & Checkbox', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Custom Styles', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'mascot-core-ventiq'),
				'label_off' => esc_html__('No', 'mascot-core-ventiq'),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Border Width', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'checkbox_heading',
			[
				'label' => esc_html__('Checkbox', 'mascot-core-ventiq'),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
		...
		$this->add_control(
			'radio_heading',
			[
				'label' => esc_html__('Radio Buttons', 'mascot-core-ventiq'),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Checked', 'mascot-core-ventiq'),
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Submit Button', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => 'custom',
				'options' => [
					'full-width' => esc_html__('Full Width', 'mascot-core-ventiq'),
					'custom' => esc_html__('Custom', 'mascot-core-ventiq'),
				],
		...
		// 1. ON/OFF switch to enable gradient
		$this->add_control(
			'enable_button_custom_bg_gradient',
			[
				'label'        => esc_html__( 'Enable Button Gradient Background', 'mascot-core-ventiq' ),
		...
		// 3. Gradient dropdown background (when switch is ON)
		$this->add_responsive_control(
			'button_custom_bg_gradient',
			[
				'label'   => esc_html__( "Button Gradient Background", 'mascot-core-ventiq' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'options' => [
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .tm-contact-form-7 .wpcf7-form input[type="submit"]' => 'background: {{VALUE}};',
				],
				'condition' => [
					'enable_button_custom_bg_gradient' => 'yes',
				],
			]
		);

		$this->add_control(
			'enable_button_background',
			[
				'label'        => esc_html__( 'Enable Button Background', 'mascot-core-ventiq' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'On', 'mascot-core-ventiq' ),
				'label_off'    => esc_html__( 'Off', 'mascot-core-ventiq' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'button_bg_type',
			[
				'label'     => esc_html__( 'Background Type', 'mascot-core-ventiq' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'solid',
				'options'   => [
...
$this->add_control(
	...
	[
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Submit Button Position', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			'spinner_icon_style',
			[
				'label' => esc_html__('After Submit Spinner Icon', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'hide_wpcf7_spinner',
			[
				'label' => esc_html__( 'Hide Spinner Icon', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Progress Range Styling (Optional)', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Label/Title Color', 'mascot-core-ventiq'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Label/Title Typography', 'mascot-core-ventiq'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Amount Color', 'mascot-core-ventiq'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Amount Typography', 'mascot-core-ventiq'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Progress Background Color', 'mascot-core-ventiq'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Bar Background Color', 'mascot-core-ventiq'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Bar Border', 'mascot-core-ventiq'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Bar Handle Background Color', 'mascot-core-ventiq'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Bar Handle Border', 'mascot-core-ventiq'),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Alert', 'mascot-core-ventiq'),
				'condition' => [
					'error_messages' => 'show',
				],
			]
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Fields', 'mascot-core-ventiq'),
				'condition' => [
					'error_messages' => 'show',
				],
			]
		...
		$this->start_controls_section(
			'ajaxloader_style',
			[
				'label' => esc_html__('Ajax Loader Image', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'hide_ajaxloader',
			[
				'label' => esc_html__('Hide Ajax Loader Image', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('After Submit Feedback', 'mascot-core-ventiq'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Radius', 'mascot-core-ventiq'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
	...
	protected function render2() {
		...
		//$html = mascot_core_ventiq_get_widgetcore_template_part( 'wpcf7', null, 'wpcf7/tpl', $settings, true );
