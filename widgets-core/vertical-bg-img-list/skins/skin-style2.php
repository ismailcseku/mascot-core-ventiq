<?php
namespace MascotCoreVentiq\Widgets\VerticalBgImgList\Skins;
...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'each-list', $settings['_skin'], 'vertical-bg-img-list/tpl', $settings, true );
