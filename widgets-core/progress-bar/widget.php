...
class TM_Elementor_Progress_Bar extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'jquery-countto', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/plugins/jquery.countto.js', array('jquery'), false, true );

		$direction_suffix = is_rtl() ? '.rtl' : '';

		wp_register_style( 'tm-progress-bar-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/progress-bar' . $direction_suffix . '.css' );
		wp_register_script( 'tm-progress-bar', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/widgets/progress-bar.js', array('jquery', 'jquery-countto'), false, true );
	}
	...
	public function get_title() {
		return esc_html__( 'Progress Bar', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "WordPress", 'mascot-core-ventiq' )
			]
		);
		$this->add_control(
			'design_style',
			[
				...
				'options' => [
					...
					'floating-percent' => esc_html__( 'Floating Percent', 'mascot-core-ventiq' ),
					'fixed-right-percent' => esc_html__( 'Fixed Right Percent', 'mascot-core-ventiq' ),
				],
				'default' => 'default'
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "85", 'mascot-core-ventiq' )
			]
		);
		$this->add_control(
			'unit_symbol_left',
			[
				'label' => esc_html__( "Unit Symbol Left", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "Add an Unit Symbol to the Left of Percent Value", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'unit_symbol_right',
			[
				'label' => esc_html__( "Unit Symbol Right", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
		...
		$this->start_controls_section(
			'other_options',
			[
				'label' => esc_html__( 'Progress Options', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'progress_color',
			[
				'label' => esc_html__( "Progress Custom Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				"description" => esc_html__( "Pick a color for progress bar. Leave empty for default value", 'mascot-core-ventiq' ),
				'default' => '#21325e',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Progress Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Progress Border Radius", 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Progress Bar Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'progress_bar_height',
			[
				'label' => esc_html__( "Progress Bar Height", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'background_color',
			[
				'label' => esc_html__( "Progress Bar Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				"description" => esc_html__( "Pick a color for the background of progress bar. Leave empty for default value", 'mascot-core-ventiq' ),
				'default' => '#eee',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Progress Bar Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Percentage Value Typography', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Percentage Value Text Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Percentage Value Text Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Percentage Value Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Percentage Value Theme Colored (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'progress-bar-' . $settings['design_style'], null, 'progress-bar/tpl', $settings, true );
