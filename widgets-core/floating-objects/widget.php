...
class TM_Elementor_Floating_Objects extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Floating Objects', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'visible_mobile',
			[
				'label' => esc_html__( "Visible on Mobile Devices?", 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'image', [
				'label' => esc_html__( "Floating Image", 'mascot-core-ventiq' ),
		...
		$repeater->add_responsive_control(
			'custom_image_size',
			[
				'label' => esc_html__( "Image Custom Size", 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'image_inline_style',
			[
				'label' => esc_html__( "Image Custom Inline CSS", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "Example: top: 12px; left: 100px;", 'mascot-core-ventiq' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Floating Objects", 'mascot-core-ventiq' ),
	...
	<?php
		if ( $settings['floating_objects_array'] ) {
			...
			foreach (  $settings['floating_objects_array'] as $item ) {
				...
				$html .= mascot_core_ventiq_get_widgetcore_template_part( 'floating-objects', null, 'floating-objects/tpl', $item, true );
			}
		}
		echo $html;
	?>
