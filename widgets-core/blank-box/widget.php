...
class TM_Elementor_Blank_Box extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-blank-box-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/blank-box' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM - Blank Box', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Shape Orientation', 'mascot-core-ventiq' ),
		...
		$repeater->add_responsive_control(
			'pos_orientation_top',
			[
				'label' => __( 'Top', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%', 'px' ],
				'range' => [
					'px' => [
		...
		$repeater->add_responsive_control(
			...
			[
				'label' => __( 'Bottom', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%', 'px' ],
				'range' => [
					'px' => [
		...
		$repeater->add_responsive_control(
			...
			[
				'label' => __( 'Left', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%', 'px' ],
				'range' => [
					'px' => [
		...
		$repeater->add_responsive_control(
			...
			[
				'label' => __( 'Right', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%', 'px' ],
				'range' => [
					'px' => [
		...
		$repeater->add_control(
			'box_rotate',
			[
				'label' => esc_html__( 'Rotate Shape', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	<?php
		if ( $settings['blank_box_array'] ) {
			...
			foreach (  $settings['blank_box_array'] as $item ) {
				...
				$html .= mascot_core_ventiq_get_widgetcore_template_part( 'blank-box', null, 'blank-box/tpl', $item, true );
			}
		}
		echo $html;
	?>
