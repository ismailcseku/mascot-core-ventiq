...
class TM_Elementor_Funfact_Counter extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-funfacts-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/funfacts' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Funfact Counter', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'funfact-default' => esc_html__( 'Default', 'mascot-core-ventiq' ),
					'funfact-number-behind-text' => esc_html__( 'Number behind Text', 'mascot-core-ventiq' ),
					'funfact-iconleft' => esc_html__( 'Icon Left', 'mascot-core-ventiq' ),
					'funfact-iconright' => esc_html__( 'Icon Right', 'mascot-core-ventiq' ),
					'funfact-horizontal' => esc_html__( 'Horizontal FunFact', 'mascot-core-ventiq' ),
					'funfact-current-theme1' => esc_html__( 'Current Theme 1', 'mascot-core-ventiq' ),
					'funfact-current-theme2' => esc_html__( 'Current Theme 2', 'mascot-core-ventiq' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Content Display Flex?", 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			'counter_margin',
			[
				'label' => esc_html__( 'Counter Margin', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_control(
			'show_paragraph', [
				'label' => esc_html__( "Show Content", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no'
			]
		);
		...
		$this->start_controls_section(
			'content_styling',
			[
				'label' => esc_html__( 'Content Styling', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
				'condition' => [
					'show_paragraph' => array('yes')
				]
		...
		$this->add_control(
			'content_color',
			[
				'label' => esc_html__( "Content Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'content_color_hover',
			[
				'label' => esc_html__( "Content Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Funfact Wrapper Style', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( $settings['design_style'], null, 'funfact-counter/tpl', $settings, true );
