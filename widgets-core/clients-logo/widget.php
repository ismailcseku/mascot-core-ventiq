...
class TM_Elementor_Clients_logo extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-clients-logo-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/clients-logo' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Clients Logo', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'tm_items_section',
			[
				'label' => esc_html__( 'Items', 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'logo_url',
			[
				'label' => esc_html__( "URL", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'link_target', [
				'label' => esc_html__( "Link Target", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'_blank'  =>  esc_html__( 'Opens in a new window or tab', 'mascot-core-ventiq' ),
					'_self' =>  esc_html__( 'Opens in the same window', 'mascot-core-ventiq' ),
				],
				'default' => '_blank'
			]
		);
		$this->add_control(
			'clients_logo_array',
			[
				'label' => esc_html__( "Clients Logo", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Hover Animation Type", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'clients-animation-no-effect' =>  esc_html__( 'No Effect', 'mascot-core-ventiq' ),
					'clients-animation-grayscale' =>  esc_html__( 'Grayscale Effect', 'mascot-core-ventiq' ),
					'clients-animation-opacity' =>  esc_html__( 'Opacity Effect', 'mascot-core-ventiq' ),
					'clients-animation-blur'  =>  esc_html__( 'Blur Effect', 'mascot-core-ventiq' ),
					'clients-animation-zoom'  =>  esc_html__( 'Zoom Effect', 'mascot-core-ventiq' ),
					'clients-animation-contrast'  =>  esc_html__( 'Contrast Effect', 'mascot-core-ventiq' ),
					'clients-animation-invert'  =>  esc_html__( 'Invert Effect', 'mascot-core-ventiq' ),
				],
		...
		$this->add_control(
			'rollover_effect',
			[
				'label' => esc_html__( "Make Roll Over Effect", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'logo_filter_options',
			[
				'label' => esc_html__( 'Filter Options', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'logo_filter_white',
			[
				'label' => esc_html__( 'Filter Logo to White', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Filter Logo to White (Hover)', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_control(
			'logo_filter_black',
			[
				'label' => esc_html__( 'Filter Logo to Black', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Filter Logo to Black (Hover)', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->start_controls_section(
			'each_logo_styling',
			[
				'label' => esc_html__( 'Each Logo Styling', 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Vertical Alignment", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Horizontal Alignment", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label' => esc_html__( 'Column Gap', 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Area Custom Width", 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo/Image Custom Width", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'separator' => 'before',
				'size_units' => [ 'px', '%' ],
				'default' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('First Child', 'mascot-core-ventiq'),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Last Child', 'mascot-core-ventiq'),
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'clients', $settings['display_type'], 'clients-logo/tpl', $settings, true );
