...
class TM_Elementor_List extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-list-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/list' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM List', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'list_repeater',
			[
				'label' => esc_html__( 'Features List', 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'disable_feature', [
				'label' => esc_html__( "Disable This Feature?", 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'content',
			[
				'label' => esc_html__( "Single Line Text", 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Individual Icon', 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			'list_icon_options',
			[
				'label' => esc_html__( 'Features List Icons Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'list_icon',
			[
				'label' => esc_html__( 'Common Icon for All', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::ICONS,
				'default' => [
		...
		$this->start_controls_section(
			'list_styling',
			[
				'label' => esc_html__( 'Features List Styling', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'List Styling (Last Item)', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_group_control(
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'list', null, 'list/tpl', $settings, true );
