<?php
namespace MascotCoreVentiq\Widgets\Tabs\Skins;
...
class Skin_Left_Nav extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Left Nav', 'mascot-core-ventiq' );
	}
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'skin-left-nav-classic'	=> 	esc_html__( "Style Classic", 'mascot-core-ventiq' ),
				],
				'default' => ''
			]
		);
	...
	public function register_layout_controls2( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'wrapper_styling',
			[
				'label' => esc_html__( 'Tab & Content Placement', 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Tab & Content Flex Direction", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_disply_flex_direction_elementor(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			'list_icon_options',
			[
				'label' => esc_html__( 'Icon Options (Tab)', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Icon Wrapper Dimension Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			'list_icon_opacity',
			[
				'label' => esc_html__( 'Icon Opacity', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$this->start_controls_section(
			'list_styling',
			[
				'label' => esc_html__( 'Text Typography/Color  (Tab)', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Wrapper of Tab Blocks', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content Wrapper Style', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Text Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	?>
		...
		?>
			...
			<ul class="nav nav-tabs flex-column list-unstyled" id="myTab-<?php echo esc_attr($settings['holder_id']); ?>" role="tablist">
			<?php
