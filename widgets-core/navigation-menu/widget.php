...
class TM_Elementor_Navigation_Menu extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-navigation-menu-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/navigation-menu' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM Navigation Menu', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		if ($simple_menus) {
			$this->add_control(
				'tm_menu_selected',
				[
					'label'       => esc_html__('Select Menu', 'mascot-core-ventiq'),
					'description' => sprintf(__('Go to the <a href="%s" target="_blank">Menu screen</a> to manage your menus.', 'mascot-core-ventiq'), admin_url('nav-menus.php')),
					...
					$this->add_control(
						'split_nav', [
							'label' => esc_html__( "Split This Nav Menu Into Two Columns", 'mascot-core-ventiq' ),
			...
			$this->add_control(
				...
				[
					...
					'raw'       => sprintf(__('<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'mascot-core-ventiq'), admin_url('nav-menus.php?action=edit&menu=0')),
					'separator' => 'after',
				]
			);
		}
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Horizontal List Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
			'list_disply_type',
			[
				'label' => esc_html__('Display Property', 'mascot-core-ventiq'),
		...
		$this->add_responsive_control(
			'list_text_alignment',
			[
				'label' => esc_html__( "List Alignment", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'hide_first_icon',
			[
				'label' => esc_html__( "Hide First Icon", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
		...
		$this->add_control(
			'hide_last_icon',
			[
				'label' => esc_html__( "Hide Last Icon", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Default', 'mascot-core-ventiq' ),
					'none'  => esc_html__( 'Hide', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'hide_all_icons',
			[
				'label' => esc_html__( "Hide All Icon", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Default', 'mascot-core-ventiq' ),
					'none'  => esc_html__( 'Hide', 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			'list_icon_options',
			[
				'label' => esc_html__( 'Icons Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'list_icon',
			[
				'label' => esc_html__( 'Icon from Library', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'translate-x'  => esc_html__( 'Translate X Left', 'mascot-core-ventiq' ),
					'translate-x-right'  => esc_html__( 'Translate X Right', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border/Shadow Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Icon Border', 'mascot-core-ventiq' ),
				'selector' => '{{WRAPPER}} .tm-sc-simple-nav-menu li .tm-nav-arrow-icon',
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Border Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			'list_styling',
			[
				'label' => esc_html__( 'Typography/Color Options', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_group_control(
		...
		$this->start_controls_section(
			'list_spacing',
			[
				'label' => esc_html__( 'List Spacing', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'navigation-menu', null, 'navigation-menu/tpl', $settings, true );
