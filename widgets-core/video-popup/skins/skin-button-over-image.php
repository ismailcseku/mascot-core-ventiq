<?php
namespace MascotCoreVentiq\Widgets\VideoPopup\Skins;
...
class Skin_Button_Over_Image extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Play Button Over Image', 'mascot-core-ventiq' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			'featured_image',
			[
				'label' => esc_html__( "Choose Featured Image", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				"description" => esc_html__( "You can upload & select background featured image", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'featured_image_size',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Overlay Color", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'play_btn',
			[
				'label' => esc_html__( "Choose Play Button From Media", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				"description" => esc_html__( "You can upload and choose play button from media", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'pre_packaged_play_btn',
			[
				'label' => esc_html__( "Or Choose Play Button From Here", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'description' => '',
				'options' => [
					'' => esc_html__( 'Default Animated Button', 'mascot-core-ventiq' ),
					's1.png' => esc_html__( 'Play Button 1', 'mascot-core-ventiq' ),
					's1.png' => esc_html__( 'Play Button 1', 'mascot-core-ventiq' ),
					's2.png' => esc_html__( 'Play Button 2', 'mascot-core-ventiq' ),
					's3.png' => esc_html__( 'Play Button 3', 'mascot-core-ventiq' ),
					's4.png' => esc_html__( 'Play Button 4', 'mascot-core-ventiq' ),
					's5.png' => esc_html__( 'Play Button 5', 'mascot-core-ventiq' ),
					's6.png' => esc_html__( 'Play Button 6', 'mascot-core-ventiq' ),
					's7.png' => esc_html__( 'Play Button 7', 'mascot-core-ventiq' ),
					's8.png' => esc_html__( 'Play Button 8', 'mascot-core-ventiq' ),
					's9.png' => esc_html__( 'Play Button 9', 'mascot-core-ventiq' ),
					's10.png' => esc_html__( 'Play Button 10', 'mascot-core-ventiq' ),
					's11.png' => esc_html__( 'Play Button 11', 'mascot-core-ventiq' ),
					's12.png' => esc_html__( 'Play Button 12', 'mascot-core-ventiq' ),
					's13.png' => esc_html__( 'Play Button 13', 'mascot-core-ventiq' ),
					's14.png' => esc_html__( 'Play Button 14', 'mascot-core-ventiq' ),
					's15.png' => esc_html__( 'Play Button 15', 'mascot-core-ventiq' ),
					's16.png' => esc_html__( 'Play Button 16', 'mascot-core-ventiq' ),
					's17.png' => esc_html__( 'Play Button 17', 'mascot-core-ventiq' )
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Title Typography', 'mascot-core-ventiq' ),
	...
	public function register_layout_controls_wrapper( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Window Width", 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Window Height", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	public function register_layout_controls_play_btn( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'icon_styling',
			[
				'label' => esc_html__( 'Play Button Styling', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'icon_size_options',
			[
				'label' => esc_html__( 'Size Options', 'mascot-core-ventiq' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Icon Typography', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'iconb_bg_color',
			[
				'label' => esc_html__( "Icon Custom Background Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Background Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'BG Colored Opacity', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$this->add_control(
			'icon_bg_color_hover',
			[
				'label' => esc_html__( "Icon Custom Background Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Background Theme Colored (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
	...
	public function render() {
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'video-popup', $settings['_skin'], 'video-popup/tpl', $settings, true );
