<?php
namespace MascotCoreVentiq\Widgets\VideoPopup;
...
class TM_Elementor_Video_Popup extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'magnific-popup', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/plugins/magnific-popup/jquery.magnific-popup.min.js', array('jquery'), false, true );
		wp_register_style( 'magnific-popup', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/plugins/magnific-popup/magnific-popup.css' );
		wp_enqueue_script( 'magnific-popup' );
		wp_enqueue_style( 'magnific-popup' );

		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_register_style( 'tm-video-popup-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/video-popup' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Video Popup', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'popup_video_url',
			[
				'label' => esc_html__( "Popup Video URL", 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Horizontal Alignment (Flex)", 'mascot-core-ventiq' ),
	...
	public function register_layout_controls_play_btn() {
		$this->start_controls_section(
			'icon_styling',
			[
				'label' => esc_html__( 'Play Button Styling Options', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'icon_size_options',
			[
				'label' => esc_html__( 'Dimension/Size Options', 'mascot-core-ventiq' ),
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'video-popup-custom-css-button', null, 'video-popup/tpl', $settings, true );
