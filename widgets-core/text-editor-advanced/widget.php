...
class TM_Elementor_TextEditorAdvanced extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-text-editor-advanced-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/text-editor-advanced' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM - Text Editor Advanced', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		//gsap animation
		mascot_core_ventiq_gsap_animation_arraylist($repeater);
		...
		$this->start_controls_section(
			'other_settings',
			[
				'label' => esc_html__( 'Content Settings', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Overlay Color Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_control(
			'bg_overlay_color',
			[
				'label' => esc_html__( "Background Overlay Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Background Overlay Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Background Overlay Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Background Overlay Theme Colored (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			'items_display_type',
			[
				'label' => esc_html__( "Items Display Type", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Flex - Justify Content center", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Flex - Align Items center", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'selectors' => [
		...
		if ( $settings['text_editor_advanced'] ) {
			...
			foreach (  $settings['text_editor_advanced'] as $item ) {
				...
				if($item['gsap_scrolling_effect'] === 'parallax') {
					$parallax_params = mascot_core_ventiq_gsap_animation_json_data($item);
				}
				?>
