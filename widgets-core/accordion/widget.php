<?php
namespace MascotCoreVentiq\Widgets\Accordion;
...
class TM_Elementor_Accordion extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-accordion-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/accordion' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Accordion', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'display_type', [
				'label' => esc_html__( "Behavior", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'accordion' =>  esc_html__( 'Accordion', 'mascot-core-ventiq' ),
					'toggle'  =>  esc_html__( 'Toggle', 'mascot-core-ventiq' ),
				],
				'default' => 'accordion'
			]
		);
		...
		$repeater->add_control(
			'expand',
			[
				'label' => esc_html__( "Make Expand?", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'title' => esc_html__( 'Accordion #1', 'mascot-core-ventiq' ),
						'expand' => 'yes',
						'content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'mascot-core-ventiq' ),
					],
					[
						'title' => esc_html__( 'Accordion #2', 'mascot-core-ventiq' ),
						'content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'mascot-core-ventiq' ),
					],
					[
						'title' => esc_html__( 'Accordion #3', 'mascot-core-ventiq' ),
						'content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'mascot-core-ventiq' ),
					],
				],
			]
		...
		$this->add_control(
			'rotate_icon',
			[
				'label' => esc_html__( 'Rotate Icon on Active', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'icon_round_border',
			[
				'label' => esc_html__( "Icon Round Border?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no'
			]
		);
		...
		$this->start_controls_tab(
			'title_style_normal',
			[
				'label' => esc_html__('Title on Normal', 'mascot-core-ventiq'),
			]
		);
		...
		$this->start_controls_tab(
			'title_style_active',
			[
				'label' => esc_html__('Title on Active', 'mascot-core-ventiq'),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Icon on Normal', 'mascot-core-ventiq'),
			]
		);
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Icon on Active', 'mascot-core-ventiq'),
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'content_padding',
			[
				'label' => esc_html__( 'Content Padding', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Wrapper on Normal', 'mascot-core-ventiq'),
			]
		);
		$this->add_responsive_control(
			'wrapper__margin',
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Wrapper on Active', 'mascot-core-ventiq'),
			]
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
	...
	protected function render() {
		...
		$settings['holder_id'] = mascot_core_ventiq_get_isotope_holder_ID('accordion');
	?>
	...
	<?php
		if ( $settings['accordion_items'] ) {
			...
			foreach (  $settings['accordion_items'] as $item ) {
				...
				$html .= mascot_core_ventiq_get_widgetcore_template_part( $settings['display_type'], null, 'accordion/tpl', $item, true );
				$i++;
			}
		}
		echo $html;
