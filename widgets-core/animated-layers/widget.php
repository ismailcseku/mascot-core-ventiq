...
class TM_Elementor_Animated_Layers extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-animated-layer-advanced-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/animated-layer-advanced' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Animated Layers', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'parent_image_animation_effect', [
				'label' => esc_html__( "On Appeared Animation Effect", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_custom_animation_class_list(),
			]
		);
		$this->add_control(
			'parent_animation_type', [
				'label' => esc_html__( "Floating Animation Type", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$repeater->add_control(
			'display_type', [
				'label' => esc_html__( "Layer Type", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'layer-image' =>  esc_html__( 'Image Layer', 'mascot-core-ventiq' ),
					'layer-text'  =>  esc_html__( 'Text Layer', 'mascot-core-ventiq' ),
					'layer-blank'  =>  esc_html__( 'Blank Layer', 'mascot-core-ventiq' ),
					'layer-animated-icon'  =>  esc_html__( 'Animated Icon', 'mascot-core-ventiq' ),
					'layer-play-btn'  =>  esc_html__( 'Video Play Button', 'mascot-core-ventiq' ),
				],
				'default' => 'layer-image'
			]
		);
		...
		$repeater->add_control(
			'play_btn_options',
			[
				'label' => esc_html__( 'Play Button Options', 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'play_btn_style', [
				'label' => esc_html__( "Video Play Button Style", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'default' =>  esc_html__( 'Default - CSS Animated', 'mascot-core-ventiq' ),
					'style-black'  =>  esc_html__( 'Style - Black', 'mascot-core-ventiq' ),
				],
				'default' => 'style-black',
				'condition' => [
					'display_type' => array('layer-play-btn')
		...
		$repeater->add_control(
			'video_url', [
				'label' => esc_html__( "Youtube Video URL", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
		...
		$repeater->add_responsive_control(
			'play_btn_width',
			[
				'label' => esc_html__( 'Play Button Dimension', 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Parent Wrapper Custom CSS class", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
		...
		$repeater->add_control(
			'animation_options',
			[
				'label' => esc_html__( 'Animation Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			'image_animation_effect', [
				'label' => esc_html__( "Appeared Animation Effect", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_custom_animation_class_list(),
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Floating Animation Duration(s) (High-Low)', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$repeater->add_control(
			'image_hover_effect', [
				'label' => esc_html__( "Image Hover Effect", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'' =>  esc_html__( 'No Effect', 'mascot-core-ventiq' ),
					'effect-shine' =>  esc_html__( 'Shine Effect', 'mascot-core-ventiq' ),
					'effect-circle'  =>  esc_html__( 'Circle Effect', 'mascot-core-ventiq' ),
					'effect-grayscale'  =>  esc_html__( 'Gray Scale Effect', 'mascot-core-ventiq' ),
					'effect-sepia'  =>  esc_html__( 'Sepia Effect', 'mascot-core-ventiq' ),
				],
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Main Parent Wrapper Custom CSS class", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "To style particular content element.", 'mascot-core-ventiq' ),
				'condition' => [
					'display_type' => array('layer-image')
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Image Parent Custom CSS class", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "To style particular content element.", 'mascot-core-ventiq' ),
				'condition' => [
					'display_type' => array('layer-image')
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Image Custom CSS class", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "To style particular content element.", 'mascot-core-ventiq' ),
				'condition' => [
					'display_type' => array('layer-image')
		...
		$repeater->add_control(
			'animated_icon_hover', [
				'label' => esc_html__( "Hover Icon", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'condition' => [
					'display_type' => array('layer-animated-icon')
				]
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Background Theme Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'condition' => [
					'display_type' => array('layer-animated-icon')
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Padding/Margin Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'condition' => [
		...
		$repeater->add_control(
			'pos_options',
			[
				'label' => esc_html__( 'Postion Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			'carousel_arrow_nav_pos_center', [
				'label' => esc_html__( "Box Position Horizontal Vertical Center", 'mascot-core-ventiq' ),
		...
		$repeater->add_control(
			'make_item_fullwidth', [
				'label' => esc_html__( "Make this Item Fullwidth?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => [
					'display_type' => array('layer-image')
		...
		$repeater->add_control(
			'make_item_maxwidth_100p', [
				'label' => esc_html__( "Make Image Max Width 100%?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
				'condition' => [
					'display_type' => array('layer-image')
		...
		$repeater->add_responsive_control(
			'space',
			[
				'label' => esc_html__( 'Max Width', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'unit' => '%',
				],
		...
		$repeater->add_responsive_control(
			'height_wrapper',
			[
				'label' => esc_html__( 'Wrapper Height', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'unit' => 'px',
				],
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Make Item Overflow Hidden", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Rotate Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$repeater->add_responsive_control(
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Background Image Overlay Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'condition' => [
					'display_type' => array('layer-text')
				],
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Background Image Overlay Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'condition' => [
					'display_type' => array('layer-text')
				],
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Paragraph Color Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'condition' => [
					'display_type' => array('layer-text')
				],
		...
		$repeater->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Paragraph Typography', 'mascot-core-ventiq' ),
				'condition' => [
					'display_type' => array('layer-text')
				],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( "Write a short description.", 'mascot-core-ventiq' ),
				'condition' => [
					'display_type' => array('layer-text')
				]
			]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Animated Layer Images", 'mascot-core-ventiq' ),
	...
	<?php
		if ( $settings['animated_layer_images'] ) {
			foreach (  $settings['animated_layer_images'] as $item ) {
				$item['wrapper_inline_css'] = mascot_core_ventiq_animated_layer_wrapper_inline_css( $item );
				$item['settings'] = $settings;
				$item['item'] = $item;
				//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
				$html .= mascot_core_ventiq_get_widgetcore_template_part( $item['display_type'], null, 'animated-layers/tpl', $item, true );
			}
		}
		echo $html;
	?>
...
if(!function_exists('mascot_core_ventiq_animated_layer_wrapper_inline_css')) {
	/**
	 * Get Wrapper Styles
	 */
	function mascot_core_ventiq_animated_layer_wrapper_inline_css( $params ) {
		$css_array = array();
