...
class TM_Elementor_Image_With_Rotated_Text extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-image-with-rotated-text-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/image-with-rotated-text' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Image With Rotated Text', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'paroller_styling',
			[
				'label' => esc_html__( 'Rotated Text Options', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'text_position',
			[
				'label' => esc_html__( "Text Position", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Stroke Color Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Stroke Color (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Stroke Theme Colored (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'image-with-rotated-text', null, 'image-with-rotated-text/tpl', $settings, true );
