...
class Skin_style8 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 8', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style8', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin8' . $direction_suffix . '.css' );
