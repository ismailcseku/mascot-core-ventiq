...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 2', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style2', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin2' . $direction_suffix . '.css' );
