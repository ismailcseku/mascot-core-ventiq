...
class Skin_style4 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 4', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style4', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin4' . $direction_suffix . '.css' );
