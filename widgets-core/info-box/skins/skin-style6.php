<?php
namespace MascotCoreVentiq\Widgets\InfoBox\Skins;
...
class Skin_style6 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 6', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style6', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin6' . $direction_suffix . '.css' );
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'info-box', $settings['_skin'], 'info-box/tpl', $settings, true );
