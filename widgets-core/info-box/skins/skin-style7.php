...
class Skin_style7 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 7', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style7', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin7' . $direction_suffix . '.css' );
