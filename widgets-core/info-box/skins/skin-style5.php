...
class Skin_style5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 5', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style5', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin5' . $direction_suffix . '.css' );
