...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 3', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style3', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin3' . $direction_suffix . '.css' );
