...
class Skin_style9 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 9', 'mascot-core-ventiq' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style9', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin9' . $direction_suffix . '.css' );
