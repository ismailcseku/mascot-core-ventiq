<?php
namespace MascotCoreVentiq\Widgets\InfoBox;
...
class TM_Elementor_InfoBox extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-info-box-loader-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'TM Info Box', 'mascot-core-ventiq' );
	}
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'tm-info-box-style1', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin1' . $direction_suffix . '.css' );
		...
		$html = mascot_core_ventiq_get_widgetcore_template_part( 'info-box', null, 'info-box/tpl', $settings, true );
