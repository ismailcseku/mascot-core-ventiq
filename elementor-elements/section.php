...
class Mascot_Core_Ventiq_Section_Handler {
    ...
    public function extend_elementor_section_options( $element ){
        ...
        $element->add_control(
            'tm_bg_color',
            [
                'label'         => esc_html__( 'Section Background Color', 'mascot-core-ventiq' ),
                'description'   => esc_html__( 'Pre-defined Background Color for this Section (ROW)', 'mascot-core-ventiq' ),
        ...
        $element->add_control(
            'tm_text_color',
            [
                'label'         => esc_html__( 'Section Text Color', 'mascot-core-ventiq' ),
                'description'   => esc_html__( 'Pre-defined Text Color in this Section (ROW)', 'mascot-core-ventiq' ),
                'type'          => Elementor\Controls_Manager::SELECT,
                'default'       => '',
    ...
    public function render_core_flex_dir_reverse_options( $section, $args ) {
        $section->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Columns Flex Reverse Options', 'mascot-core-ventiq' ),
                'tab'   => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__( "Columns Flex Direction Reverse", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'selectors' => [
    ...
    public function register_controls_custom_width($section, $args) {
        ...
        $section->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Section Custom Width', 'mascot-core-ventiq' ),
                'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_responsive_control(
        ...
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__('Section Left/Right Margin Auto', 'mascot-core-ventiq'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'e-auto' => [
        ...
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Section Inner Custom Width (px)', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'separator' => 'before',
                'range' => [
                    'px' => [
...
if ( ! function_exists( 'mascot_core_ventiq_init_section_handler_legacy' ) ) {
    function mascot_core_ventiq_init_section_handler_legacy() {
        Mascot_Core_Ventiq_Section_Handler::get_instance();
    }

    // Priority 20 ensures it runs after plugin initialization (priority 5) and theme framework (priority 10)
    add_action( 'init', 'mascot_core_ventiq_init_section_handler_legacy', 20 );
}