...
class Mascot_Core_Ventiq_Column_Handler {
	...
	public function tm_elementor_column_options( $element ){
		...
		$element->add_control(
			'tm_bg_color',
			[
				'label'			=> esc_html__( 'Column Background Color', 'mascot-core-ventiq' ),
				'description'	=> esc_html__( 'Pre-defined Background Color for this Column', 'mascot-core-ventiq' ),
		...
		$element->add_control(
			'tm_text_color',
			[
				'label'			=> esc_html__( 'Column Text Color', 'mascot-core-ventiq' ),
				'description'	=> esc_html__( 'Pre-defined Text Color in this Column', 'mascot-core-ventiq' ),
				'type'			=> Elementor\Controls_Manager::SELECT,
				'default'		=> '',
	...
	public function render_parallax_options( $section, $args ) {
		...
		$section->add_responsive_control(
			...
			[
				'label' => esc_html__( "Appear Animation", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
		...
		$section->start_controls_section(
			'stretched_bg',
			[
				'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Stretched BG', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_LAYOUT,
			]
		);
		$section->add_control(
			...
			[
				'label'        => esc_html__( 'Stretched Background Direction', 'mascot-core-ventiq'),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'no',
				'options' => [
					'no'    => esc_html__( 'No', 'mascot-core-ventiq' ),
					'tm-stretched-bg-both'  => esc_html__( 'Both', 'mascot-core-ventiq' ),
					'tm-stretched-bg-left'  => esc_html__( 'Left', 'mascot-core-ventiq' ),
					'tm-stretched-bg-right' => esc_html__( 'Right', 'mascot-core-ventiq' )
				],
			]
		);
		$section->add_group_control(
			...
			[
				...
				'label' => esc_html__('Stretched Background Image', 'mascot-core-ventiq'),
		...
		$section->add_control(
			...
			[
				'label' => esc_html__( "Stretched Background Custom CSS class", 'mascot-core-ventiq' ),
		...
		$section->add_control(
			'stretched_bg_style',
			[
				'label' => esc_html__( "Stretched Background Custom Inline CSS", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "Example: background-color: #f1f1f1;", 'mascot-core-ventiq' ),
				'condition' => [
					'stretched_bg_direction' => array('tm-stretched-bg-both', 'tm-stretched-bg-left', 'tm-stretched-bg-right')
				]
			]
...
if ( ! function_exists( 'mascot_core_ventiq_init_column_handler' ) ) {
	function mascot_core_ventiq_init_column_handler() {
		Mascot_Core_Ventiq_Column_Handler::get_instance();
	}

	// Priority 20 ensures it runs after plugin initialization (priority 5) and theme framework (priority 10)
	add_action( 'init', 'mascot_core_ventiq_init_column_handler', 20 );
}