...
class Mascot_Core_Ventiq_Container_Handler {
    ...
    public function tm_elementor_enqueue_base_scripts(){
        wp_enqueue_script( 'tm-elementor-base', MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/tm-stretch-base.js' );
    }

    public function tm_elementor_enqueue_front_scripts(){
        wp_enqueue_script( 'tm-elementor-script', MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/tm-stretch.js' );
        wp_enqueue_style( 'tm-elementor-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/tm-stretch.css' );
        if ( defined('ELEMENTOR_VERSION') && \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
            wp_enqueue_script(  'tm-elementor-frontview', MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/elementor-frontview.js' );
        }
    }
    ...
    public function extend_elementor_gsap_scroll_fixed_options( $element ){
        ...
        $element->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . __('TM GSAP Pin Scroll Fixed', 'mascot-core-ventiq'),
		...
		$element->add_control(
			'gsap_scroll_fixed',
			[
				'label'     => __('Pin Scroll Fixed', 'mascot-core-ventiq'),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'options'   => [
					'' => __('Default', 'mascot-core-ventiq'),
					'gsap-pin-fixed-boxed' 	=> __('Enable For Boxed Parent Container', 'mascot-core-ventiq'),
					'gsap-pin-fixed-fullwidth' 	=> __('Enable For Fullwidth Parent Container', 'mascot-core-ventiq')
				],
				'default'   => '',
			]
		);
		$element->add_control(
			...
			[
				'label' => esc_html__( 'Start at (e.g. 200)', 'mascot-core-ventiq' ),
        ...
        $element->add_control(
			...
			[
				'label' => esc_html__('Responsive Condition', 'mascot-core-ventiq'),
        ...
        $element->add_control(
			...
			[
				'label'     => __('Stop Under Devices', 'mascot-core-ventiq'),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'options'   => [
					'' => __('None', 'mascot-core-ventiq'),
					'laptop' 	=> __('Laptop', 'mascot-core-ventiq'),
					'tablet' 	=> __('Tablet', 'mascot-core-ventiq'),
					'mobile' 	=> __('Mobile', 'mascot-core-ventiq'),
				],
				'default'   => 'mobile',
                'condition' => [
                    'gsap_scroll_fixed' => ['gsap-pin-fixed-boxed', 'gsap-pin-fixed-fullwidth']
    ...
    public function extend_elementor_section_options( $element ){
        ...
        $element->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . __('TM BG Stretched Options', 'mascot-core-ventiq'),
                'tab' => Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        ...
        $element->add_control(
            'tm-extended-column',
            [
                'label'         => esc_attr__( 'Extend Column for background image', 'mascot-core-ventiq' ),
                'description'   => esc_attr__( 'Select which column will be extended with background image.', 'mascot-core-ventiq' ),
                'type'          => 'tm_imgselect',
                'label_block'   => true,
                'hide_in_inner' => true,
                'thumb_width'   => '110px',
                ...
                'options' => [
                    'none'          => MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/elementor/bg-stretched-none.png',
                    'left'          => MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/elementor/bg-stretched-first.png',
                    'right'         => MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/elementor/bg-stretched-last.png',
                    'both'          => MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/elementor/bg-stretched-both.png',
                ],
            ]
        );
        ...
        $element->add_control(
            ...
            [
                'label'         => esc_attr__( 'Also stretch left content too?', 'mascot-core-ventiq' ),
                'description'   => esc_attr__( 'Also stretch left content too?', 'mascot-core-ventiq' ),
                'type'          => Elementor\Controls_Manager::SWITCHER,
                'prefix_class'  => 'tm-left-col-stretched-content-',
                'hide_in_inner' => true,
                'label_on'      => esc_attr__( 'Yes', 'mascot-core-ventiq' ),
                'label_off'     => esc_attr__( 'No', 'mascot-core-ventiq' ),
                'return_value'  => 'yes',
                'default'       => '',
                'condition'     => [
        ...
        $element->add_control(
            ...
            [
                'label'         => esc_attr__( 'Also stretch right content too?', 'mascot-core-ventiq' ),
                'description'   => esc_attr__( 'Also stretch right content too?', 'mascot-core-ventiq' ),
                'type'          => Elementor\Controls_Manager::SWITCHER,
        ...
        $element->add_control(
            'tm-left-margin',
            [
                'label'         => esc_html__( 'Left Content Area Margin', 'mascot-core-ventiq' ),
                'description'   => esc_html__( 'This is useful if you like to overlap columns on each other.', 'mascot-core-ventiq' ),
        ...
        $element->add_control(
            'tm-right-margin',
            [
                'label'         => esc_html__( 'Right Content Area Margin', 'mascot-core-ventiq' ),
                'description'   => esc_html__( 'This is useful if you like to overlap columns on each other.', 'mascot-core-ventiq' ),
                'type'          => Elementor\Controls_Manager::DIMENSIONS,
                'selectors' => [
        ...
        $element->add_control(
            'tm_bg_color',
            [
                'label'         => esc_html__( 'Container Background Color', 'mascot-core-ventiq' ),
                'description'   => esc_html__( 'Pre-defined Background Color for this Container (ROW)', 'mascot-core-ventiq' ),
                'type'          => Elementor\Controls_Manager::SELECT,
                'default'       => '',
                'separator'     => 'before',
                'prefix_class'  => 'tm-bg-color-yes tm-elementor-bg-color-',
                'options'       => [
                    ''              => esc_attr__( 'Transparent', 'mascot-core-ventiq' ),
                    'white'         => esc_attr__( 'White', 'mascot-core-ventiq' ),
                    'light'         => esc_attr__( 'Light', 'mascot-core-ventiq' ),
                    'blackish'      => esc_attr__( 'Blackish', 'mascot-core-ventiq' ),
                    'globalcolor'   => esc_attr__( 'Global Color', 'mascot-core-ventiq' ),
                    'secondary'     => esc_attr__( 'Secondary Color', 'mascot-core-ventiq' ),
                    'gradient'      => esc_attr__( 'Gradient Color', 'mascot-core-ventiq' ),
                ],
            ]
        );
        ...
        $element->add_control(
            'tm_text_color',
            [
                'label'         => esc_html__( 'Container Text Color', 'mascot-core-ventiq' ),
                'description'   => esc_html__( 'Pre-defined Text Color in this Container (ROW)', 'mascot-core-ventiq' ),
                'type'          => Elementor\Controls_Manager::SELECT,
                'default'       => '',
                'prefix_class'  => 'tm-text-color-',
                'options' => [
                    ''          => __( 'Default', 'mascot-core-ventiq' ),
                    'white'     => __( 'White', 'mascot-core-ventiq' ),
                    'blackish'  => __( 'Blackish', 'mascot-core-ventiq' ),
                ],
            ]
        );
        ...
        $element->add_control(
            ...
            [
                'label'         => esc_attr__( 'BG Image - BG Color Order', 'mascot-core-ventiq' ),
                'description'   => esc_attr__( 'You can show BG image over BG Color or reverse too.', 'mascot-core-ventiq' ),
                'type'          => 'tm_imgselect',
                'label_block'   => true,
                'thumb_width'   => '110px',
                'default'       => 'none',
                ...
                'options'       => [
                    'image-over-color'  => MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/elementor/img-over-color.png',
                    'color-over-image'  => MASCOT_CORE_VENTIQ_ASSETS_URI . '/section-col-stretch/elementor/color-over-img.png',
                ],
            ]
        );
    ...
    public function render_core_options( $section, $args ) {
        $section->start_controls_section(
            'tm_core_options',
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Core Options', 'mascot-core-ventiq' ),
                'tab'   => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        ...
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Section Custom Width (px)', 'mascot-core-ventiq' ),
        ...
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__( "BG Overlay Display Type", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'block' =>  esc_html__( "Show", 'mascot-core-ventiq' ),
        ...
        $section->add_control(
            ...
            [
                'label' => esc_html__( 'Clip Path Animation', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Clip Path Appear Animation", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    '' =>  esc_html__( 'No Animation', 'mascot-core-ventiq' ),
                    'tm-item-appear-clip-path'  =>  esc_html__( 'Clip Path Animation', 'mascot-core-ventiq' ),
                    'tm-item-appear-clip-path-right'  =>  esc_html__( 'Clip Path Animation Right to Left', 'mascot-core-ventiq' ),
                    'tm-appear-block-holder'  =>  esc_html__( 'Block Clip Path Animation', 'mascot-core-ventiq' ),
                ],
            ]
        );
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Color1", 'mascot-core-ventiq' ),
        ...
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Color2", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'condition' => [
                    'tm_section_appear_animation' => array('tm-appear-block-holder')
                ],
        ...
        $section->add_control(
            ...
            [
                'label' => esc_html__( 'Wow Animation', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Wow Animate Delay(ms or s)", 'mascot-core-ventiq' ),
        ...
        $section->add_control(
            'activate_text_gradient_background_fill', [
                'label' => esc_html__( "Activate Gradient BG Fill/Clip?", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no',
                'separator' => 'before',
            ]
        ...
        $section->add_responsive_control(
            "text_gradient_background_fill", [
                'label' => esc_html__( "Text Gradient Background Fill Effect?", 'mascot-core-ventiq' ),
    ...
    public function render_curve_bg_options( $section, $args ) {
        $section->start_controls_section(
            'tm_curve_bg_options',
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Curve BG Options', 'mascot-core-ventiq' ),
                'tab'   => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_control(
            'tm_curve_bg_enable',
            [
                'label'         => esc_attr__( 'Enable Curve BG?', 'mascot-core-ventiq' ),
                'type'          => \Elementor\Controls_Manager::SWITCHER,
        ...
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Curve BG 1st Theme Colored", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_ventiq_theme_color_list(),
                'default' => '',
                'selectors' => [
        ...
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Curve BG 1st Custom Color", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Curve BG 1st Custom Width', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 20,
        ...
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Curve BG 2nd Theme Colored", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_ventiq_theme_color_list(),
                'default' => '',
                'selectors' => [
        ...
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Curve BG 2nd Custom Color", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Curve BG 2nd Custom Width', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 20,
    ...
    public function register_controls_custom_width($section, $args) {
        ...
        $section->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Container Custom Width', 'mascot-core-ventiq' ),
                'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Container Custom Width (px)', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 100,
        ...
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__('Container Left/Right Margin Auto', 'mascot-core-ventiq'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'e-auto' => [
                        'title' => esc_html__('Left Auto', 'mascot-core-ventiq'),
                        'icon' => 'eicon-h-align-left',
                    ],
                    's-auto' => [
                        'title' => esc_html__('Right Auto', 'mascot-core-ventiq'),
        ...
        $section->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Container Inner Custom Width (px)', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'separator' => 'before',
                'range' => [
                    'px' => [
    ...
    public function register_controls_equal_height($section, $args) {
        ...
        $section->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Equal Height', 'mascot-core-ventiq' ),
                'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_control(
            ...
            [
                'label'        => esc_html__( 'Enable Equal Height', 'mascot-core-ventiq' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'return_value' => 'yes',
                'description'  => esc_html__( 'You can equal your column/widgets height equal by enable this option.', 'mascot-core-ventiq' ),
            ]
        );
        $section->add_control(
            'tm_section_equal_height_selector',
            [
                'label'     => esc_html__( 'Equal Height For', 'mascot-core-ventiq' ),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'options'   => [
                    'column'     => 'Columns',
                    'widgets'    => 'Widgets',
        ...
        $section->add_control(
            ...
            [
                'label'       => esc_html__( 'Custom Selector', 'mascot-core-ventiq' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
        ...
        $section->add_control(
            ...
            [
                'label'        => esc_html__( 'Disable On Tablet', 'mascot-core-ventiq' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'default'      => 'no',
                'condition'   => [
                    'tm_section_equal_height_on' => 'yes',
        ...
        $section->add_control(
            ...
            [
                'label'        => esc_html__( 'Disable On Mobile', 'mascot-core-ventiq' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'default'      => 'yes',
                'condition'   => [
                    'tm_section_equal_height_on' => 'yes',
    ...
    public function other_options( $section, $args ) {
        $section->start_controls_section(
            'tm_other_options',
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Other Options', 'mascot-core-ventiq' ),
                'tab'   => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Show Four Vertical Lines in Background?", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Show Smaill Vertical Lines in Background?", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
    ...
    public function bg_move_effect_options( $section, $args ) {
        $section->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - BG Gsap Clip Path Effect', 'mascot-core-ventiq' ),
                'tab'   => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_control(
            ...
            [
                'label' => esc_html__( "Enable BG Move Effect?", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
...
if ( ! function_exists( 'mascot_core_ventiq_init_section_handler' ) ) {
    function mascot_core_ventiq_init_section_handler() {
        Mascot_Core_Ventiq_Container_Handler::get_instance();
    }

    // Priority 20 ensures it runs after plugin initialization (priority 5) and theme framework (priority 10)
    add_action( 'init', 'mascot_core_ventiq_init_section_handler', 20 );
}