...
class TM_Elementor_Product_Tabs extends Widget_Base {
	public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-product-tabs', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/woo/product-tabs' . $direction_suffix . '.css' );
		wp_register_script( 'tm-product-tabs', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/woo/product-tabs' . $direction_suffix . '.js' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM Product Tabs', 'mascot-core-ventiq' );
	}
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'style_list',
            [
                'label'     => esc_html__('List Style', 'mascot-core-ventiq'),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'default'   => 1,
                'options'   => [
                    1 => esc_html__('Style 1', 'mascot-core-ventiq'),
                    2 => esc_html__('Style 2', 'mascot-core-ventiq'),
                ],
            ]
        );
        $this->add_responsive_control(
            'column',
            [
                'label'          => esc_html__('columns', 'mascot-core-ventiq'),
                'type'           => \Elementor\Controls_Manager::SELECT,
                'default'        => 3,
        ...
        $repeater->add_control(
            'tab_title',
            [
                'label'       => esc_html__('Tab Title', 'mascot-core-ventiq'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('#Product Tab', 'mascot-core-ventiq'),
                'placeholder' => esc_html__('Product Tab Title', 'mascot-core-ventiq'),
            ]
        );
        $repeater->add_control(
            'product_type',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'tab_title' => esc_html__('Tab 1', 'mascot-core-ventiq'),
                    ],
                    [
                        'tab_title' => esc_html__('Tab 2', 'mascot-core-ventiq'),
                    ]
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Tab Wrapper', 'mascot-core-ventiq'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Wrapper Background Color', 'mascot-core-ventiq'),
        ...
        $this->add_responsive_control(
            'align_items',
            [
                'label'        => esc_html__('Tab Align', 'mascot-core-ventiq'),
        ...
        $this->add_responsive_control(
            'header_margin',
            [
                'label'      => esc_html__('Tab Margin', 'mascot-core-ventiq'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->start_controls_section(
            'section_title_style',
            [
                'label' => esc_html__('Each Tab Styling', 'mascot-core-ventiq'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'tab_title_spacing',
            [
                'label'      => esc_html__('Horizontal Padding', 'mascot-core-ventiq'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__('Vertical Padding', 'mascot-core-ventiq'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
    ...
    protected function add_control_carousel($condition = array()) {
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Swiper Slider Options', 'mascot-core-ventiq'),
        ...
        $this->add_control(
            'enable_carousel',
            [
                'label' => esc_html__('Enable', 'mascot-core-ventiq'),
        ...
        $this->add_control(
            'navigation',
            [
                'label'     => esc_html__('Navigation', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'dots',
                'options'   => [
                    'both'   => esc_html__('Arrows and Dots', 'mascot-core-ventiq'),
                    'arrows' => esc_html__('Arrows', 'mascot-core-ventiq'),
                    'dots'   => esc_html__('Dots', 'mascot-core-ventiq'),
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label'     => esc_html__('Pause on Hover', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label'     => esc_html__('Autoplay Speed', 'mascot-core-ventiq'),
        ...
        $this->start_controls_section(
            'carousel_arrows',
            [
                'label'      => esc_html__('Carousel Arrows', 'mascot-core-ventiq'),
                'conditions' => [
                    'relation' => 'and',
                    'terms'    => [
                        [
        ...
        $this->add_control(
            'next_heading',
            [
                'label' => esc_html__('Next button', 'mascot-core-ventiq'),
        ...
        $this->add_control(
            'next_vertical',
            [
                'label'       => esc_html__('Next Vertical', 'mascot-core-ventiq'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'top'    => [
        ...
        $this->add_control(
            'next_horizontal',
            [
                'label'       => esc_html__('Next Horizontal', 'mascot-core-ventiq'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'left'  => [
        ...
        $this->add_control(
            'prev_heading',
            [
                'label'     => esc_html__('Prev button', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
        ...
        $this->add_control(
            'prev_vertical',
            [
                'label'       => esc_html__('Prev Vertical', 'mascot-core-ventiq'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'top'    => [
        ...
        $this->add_control(
            'prev_horizontal',
            [
                'label'       => esc_html__('Prev Horizontal', 'mascot-core-ventiq'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'left'  => [
    ...
    private function woocommerce_default($settings, $global_setting) {
        ...
        $html = mascot_core_ventiq_get_shortcode_shop_template_part( 'product-tabs', null, 'product-tabs/tpl', $settings, true );
