					...
					<div class="product-wrapper">
						<div class="product-header">
							<?php
								...
								mascot_core_ventiq_woocommerce_get_product_label_stock();
							...
							<div class="product-button-holder">
								<?php
								mascot_core_ventiq_compare_button();
								mascot_core_ventiq_wishlist_button();
								mascot_core_ventiq_quickview_button();
								?>
							</div>
						</div>
