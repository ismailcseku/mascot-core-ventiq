...
class TM_Elementor_InfoBanner extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-info-banner-advanced-style', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/woo/info-banner-advanced/info-banner-advanced' . $direction_suffix . '.css' );
		wp_register_script( 'tm-info-banner-advanced-script', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/woo/info-banner.js' );
	}
	...
	*/
	public function get_title() {
		return esc_html__( 'Info Banner', 'mascot-core-ventiq' );
	}
  	...
  	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'layout-top-reveal' => esc_html__( 'Top Reveal', 'mascot-core-ventiq' ),
					'layout-center'  => esc_html__( 'Center Standard', 'mascot-core-ventiq' ),
					'layout-bottom'  => esc_html__( 'From Bottom', 'mascot-core-ventiq' ),
					'layout-image-switch'  => esc_html__( 'Image Switch', 'mascot-core-ventiq' ),
					'layout-basic'  => esc_html__( 'Basic', 'mascot-core-ventiq' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Flex Options', 'mascot-core-ventiq' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Flex Vertical Alignment", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Flex Horizontal Alignment", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "Example title", 'mascot-core-ventiq' ),
			]
		);
		$this->add_control(
			'title_tag',
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( "Example subtitle", 'mascot-core-ventiq' ),
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Sub Title Vertical Alignment", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_disply_flex_vertical_align_elementor(),
				'default' => '',
				'selectors' => [
		...
		$repeater->add_control(
			'subtitle_other_text',
			[
				'label' => esc_html__( "Subtitle Text", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
			]
		);
		$repeater->add_control(
		...
		$this->add_control(
			'subtitle_list',
			[
				'label' => esc_html__( "Subtitle Other Parts", 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			'paragraph_opt',
			[
				'label' => esc_html__( 'Content - Paragraph', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Background Image/Color', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Background Overlay', 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Floating PNG Image', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Floating PNG Image (Hover)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Floating Image Size", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Animation', 'mascot-core-ventiq'),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Hover Crystal Animation Effect", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'hover-linear-crystal-animation' => esc_html__( 'Linear Crystal Animation', 'mascot-core-ventiq' ),
					'hover-cross-crystal-animation' => esc_html__( 'Cross/Plus Crystal Animation', 'mascot-core-ventiq' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Enable Background Zoom Effect', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show Circle Animation', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Circle Background Color', 'mascot-core-ventiq'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Circle Opacity', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show Inner Border Around Wrapper', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Inner Border Around Wrapper', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'link',
			[
				'label' => esc_html__( "Button Link URL", 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'link_subtitle',
			[
				'label' => esc_html__( "Link to Subtitle?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		$this->add_control(
			'link_title',
			[
				'label' => esc_html__( "Link to Title?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		...
		$this->start_controls_section(
			'button_options',
			[
				'label' => esc_html__( 'Button', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'link_icon_title',
			[
				'label' => esc_html__( "Link Icon, Title and Button?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		...
		mascot_core_ventiq_get_button_arraylist($this, 13);
		mascot_core_ventiq_get_button_arraylist($this, 14);
		mascot_core_ventiq_get_button_arraylist($this, 15);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			'button_icon_options', [
				'label' => esc_html__( 'Button Icon', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'add_btnicon_left',
			[
				'label' => esc_html__( "Show Button Icon Left?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'add_btnicon_right',
			[
				'label' => esc_html__( "Show Button Icon Right?", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Border Around Wrapper', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Banner Wrapper Style', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
	...
	*/
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_shop_template_part( 'info-banner', $settings['layout'], 'info-banner/tpl', $settings, true );
