...
class TM_Elementor_Header_Search extends Widget_Base {
	public function __construct($data = [], $args = null) {
        ...
        wp_enqueue_script('tm-header-search-popup', MASCOT_CORE_VENTIQ_ASSETS_URI . '/js/woo/header-search-popup.js', array('jquery'), MASCOT_CORE_VENTIQ_VERSION, true);
	}
	...
	public function get_title() {
		return esc_html__( 'Header Search', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Settings', 'mascot-core-ventiq'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'default',
                'options' => [
                    'default' => esc_html__('Search Form', 'mascot-core-ventiq'),
                    'form-cat' => esc_html__('Search Form with Category', 'mascot-core-ventiq'),
        ...
        $this->add_control(
            'search_type',
            [
                'label'   => esc_html__('Search Type', 'mascot-core-ventiq'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => esc_html__('Default Search', 'mascot-core-ventiq'),
                    'product' => esc_html__('Product Search', 'mascot-core-ventiq'),
                ],
                'condition' => [
        ...
        $this->add_control(
            'search_submit_style',
            [
                'label'   => esc_html__('Submit Button Style', 'mascot-core-ventiq'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'submit-icon',
                'options' => [
                    'submit-text' => esc_html__('Submit Text', 'mascot-core-ventiq'),
                    'submit-icon'    => esc_html__('Submit Icon', 'mascot-core-ventiq'),
                ],
                'prefix_class'	=> 'search-',
                'condition' => [
        ...
        $this->add_control(
            'placeholder_text',
            [
                'label' => esc_html__( "Placeholder Text", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( "Search Product...", 'mascot-core-ventiq' ),
                'condition' => [
                    'search_layout!' => 'icon'
                ]
            ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style Form', 'mascot-core-ventiq'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Option', 'mascot-core-ventiq' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Icon', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Input Field Options', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Input Text Color', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Submit Button Options', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Submit Search Icon Options', 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            ...
            [
                'label' => esc_html__( "Search Icon Color", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} form button i' => 'color: {{VALUE}};',
                ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( "Search Icon Color (Hover)", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'border_color_focus',
            [
                'label'     => esc_html__('Border Color Focus', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( "Border Focus Theme Colored", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_ventiq_theme_color_list(),
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style Form - Input Text', 'mascot-core-ventiq'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                        'search_layout' => 'default'
                ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style Form - Submit Button', 'mascot-core-ventiq'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                        'search_layout' => 'default'
                ]
        ...
        $this->add_responsive_control(
            'form_submit_bg_size',
            [
                'label'     => esc_html__('Submit Button Background Size', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 20,
        ...
        $this->add_responsive_control(
            'form_submit_pos_top',
            [
                'label'     => esc_html__('Position - Top', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => esc_html__('Position - Right', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Icon (Hover)', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} form button:hover i' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( "Border (Hover) Theme Colored", 'mascot-core-ventiq' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_ventiq_theme_color_list(),
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style Icon', 'mascot-core-ventiq'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'search_layout' => 'icon'
                ]
	...
	protected function render() {
		...
		$html = mascot_core_ventiq_get_shortcode_shop_template_part( 'tpl-search', $settings['search_layout'], 'header-search/tpl', $settings, true );
