...
class TM_Elementor_Wishlist extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-woo-wishlist', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/woo/wishlist' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM Wishlist', 'mascot-core-ventiq' );
	}
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'show_count',
            [
                'label'        => esc_html__('Hide Count', 'mascot-core-ventiq'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background (Hover)', 'mascot-core-ventiq'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
