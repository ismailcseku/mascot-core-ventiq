<?php
namespace MascotCoreVentiq\Widgets\Products_Category;
...
class TM_Elementor_Products_Category extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-product-category', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/woo/product-category/product-category-loader' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM - Product Category', 'mascot-core-ventiq' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'categories_name',
			[
				'label' => esc_html__('Alternate Name', 'mascot-core-ventiq'),
		...
		$this->add_control(
			'show_count', [
				'label' => esc_html__( "Show Product Count", 'mascot-core-ventiq' ),
		...
		$this->start_controls_section(
			'category_image_opt',
			[
				'label' => esc_html__( 'Category Image', 'mascot-core-ventiq' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'flat-icon' => esc_html__( 'Flat Icon', 'mascot-core-ventiq' ),
		...
		$this->add_control(
			'category_image',
			[
				'label'      => esc_html__('Choose Category Image', 'mascot-core-ventiq'),
				'default'    => [
		...
		$this->add_control(
			'category_flaticon',
			[
				'label' => __('Choose Category Flat Icon', 'mascot-core-ventiq'),
		...
		$this->start_controls_section(
			'bg_style',
			[
				'label' => esc_html__('Background Option (Default Skin)', 'mascot-core-ventiq'),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Background Width', 'mascot-core-ventiq'),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Background Height', 'mascot-core-ventiq'),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			'count_style',
			[
				'label' => esc_html__('Count Value', 'mascot-core-ventiq'),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'count_margin',
			[
				'label' => esc_html__( 'Count Value Margin', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_section(
			'paragraph_style',
			[
				'label' => esc_html__('Paragraph Style', 'mascot-core-ventiq'),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'paragraph_margin',
			[
				'label' => esc_html__( 'Paragraph Value Margin', 'mascot-core-ventiq' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
	...
	protected function render() {
		...
		if (empty($settings['categories'])) {
			echo esc_html__('Choose Category', 'mascot-core-ventiq');
			return;
		}
		...
		if (!is_wp_error($category) && !empty($category)) {
			...
			<div class="tm-product-category-default">
				...
				<div class="cat-details">
					...
					<div class="count"><?php echo esc_html($category->count) . ' ' . esc_html__('products', 'mascot-core-ventiq'); ?> </div>
