...
class Skin_Current_Theme5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Current Theme5', 'mascot-core-ventiq' );
	}
	...
	public function register_layout_controls1( Widget_Base $widget ) {
		...
		$this->add_control(
			'leaf_image',
			[
				'label' => esc_html__( "Leaf Image", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				"description" => esc_html__( "Upload the Leaf image", 'mascot-core-ventiq' ),
			]
		);
		...
		$this->start_controls_section(
			'current_style',
			[
				'label' => esc_html__('Color Options (Current Theme Skin4)', 'mascot-core-ventiq'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Counter Color Options (Current Theme Skin4)', 'mascot-core-ventiq'),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Count Value Color', 'mascot-core-ventiq'),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Count Value Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
