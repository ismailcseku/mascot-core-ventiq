<?php
namespace MascotCoreVentiq\Widgets\Products_Category\Skins;
...
class Skin_Current_Theme2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Current Theme2', 'mascot-core-ventiq' );
	}
	...
	public function register_layout_controls1( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Background Option (Current Theme2 Skin)', 'mascot-core-ventiq'),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Wrapper Border Color', 'mascot-core-ventiq'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Wrapper Border Theme Colored", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Top Image Circle Background', 'mascot-core-ventiq'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Link Button Color', 'mascot-core-ventiq'),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Footer Text Color/Typo', 'mascot-core-ventiq'),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Text Height', 'mascot-core-ventiq'),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
