...
class TM_Elementor_Vertical_Menu extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-vertical-menu', MASCOT_CORE_VENTIQ_ASSETS_URI . '/css/woo/vertical-menu' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM Vertical Menu', 'mascot-core-ventiq' );
	}
    ...
    protected function register_controls() {
        $this -> start_controls_section(
            ...
            [
                'label' => esc_html__('Config','mascot-core-ventiq'),
        ...
        if (!empty($menus)) {
            $this->add_control(
                'menu',
                [
                    'label' => esc_html__('Menu', 'mascot-core-ventiq'),
                    'type' => Controls_Manager::SELECT,
                    'options' => $menus,
                    'default' => array_keys($menus)[0],
                    'save_default' => true,
                    'separator' => 'after',
                    'description' => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'mascot-core-ventiq'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw' => '<strong>' . esc_html__('There are no menus in your site.', 'mascot-core-ventiq') . '</strong><br>' . sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'mascot-core-ventiq'), admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator' => 'after',
        ...
        $this -> add_control(
            'nav_vertiacl_layout',
            [
                'label' => esc_html__('Menu Layout', 'mascot-core-ventiq'),
                'type'  => Controls_Manager::SELECT,
                'options'   => [
                    'style-1' => esc_html__('Dropdown', 'mascot-core-ventiq'),
                    'style-2' =>  esc_html__('Navbar', 'mascot-core-ventiq'),
                ],
                'default'   => 'style-1',
        ...
        $this->add_responsive_control(
            'icon_menu_size',
            [
                'label' => esc_html__('Size Icon', 'mascot-core-ventiq'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub Menu', 'mascot-core-ventiq'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Active', 'mascot-core-ventiq'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
    ...
    protected function render() {
        ...
        <div <?php echo $this->get_render_attribute_string('wrapper'); ?>>
            <?php
            ?>
            <nav class="vertical-navigation" aria-label="<?php esc_attr_e('Vertiacl Navigation', 'mascot-core-ventiq'); ?>">
