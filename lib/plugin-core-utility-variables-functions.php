...
if(!function_exists('mascot_core_ventiq_theme_color_list')) {
	/**
	 * Theme Color list
	 */
	function mascot_core_ventiq_theme_color_list() {
		$theme_color_list = array(
			'' => esc_html__( 'No', 'mascot-core-ventiq' ),
			'1' => esc_html__( 'Theme Color 1', 'mascot-core-ventiq' ),
			'2' => esc_html__( 'Theme Color 2', 'mascot-core-ventiq' ),
			'3' => esc_html__( 'Theme Color 3', 'mascot-core-ventiq' ),
			'4' => esc_html__( 'Theme Color 4', 'mascot-core-ventiq' )
		);
		return $theme_color_list;
	}
}

if(!function_exists('mascot_core_ventiq_number_of_theme_colors')) {
	/**
	 * Number of Theme Colors Used in this theme
	 */
	function mascot_core_ventiq_number_of_theme_colors() {
		$number_of_theme_colors = 4;
		if( function_exists('ventiq_number_of_theme_colors') ) {
			$number_of_theme_colors = ventiq_number_of_theme_colors();
		}
		return $number_of_theme_colors;
	}
}

if(!function_exists('mascot_core_ventiq_icon_font_packs')) {
	/**
	 * Theme Color list
	 */
	function mascot_core_ventiq_icon_font_packs( $icon_type = 'font_awesome' ) {
		$icon_font_packs = array();
		if( function_exists('ventiq_icon_font_packs') ) {
			$icon_font_packs = ventiq_icon_font_packs()->getIconFontPackByKey($icon_type)->getFileTypeIconList();
		}
		return $icon_font_packs;
	}
}

if(!function_exists('mascot_core_ventiq_animate_css_animation_list')) {
	/**
	 * animate.css animation list https://daneden.github.io/animate.css/
	 */
	function mascot_core_ventiq_animate_css_animation_list() {
...
if(!function_exists('mascot_core_ventiq_custom_animation_class_list')) {
	/**
	 * custom made animation list
	 */
	function mascot_core_ventiq_custom_animation_class_list() {
		$class_list = array(
			''	=>	esc_html__( "None", 'mascot-core-ventiq' ),
			'fade-in'	=>	esc_html__( "fade-in", 'mascot-core-ventiq' ),
			'move-up'	=>	esc_html__( "move-up", 'mascot-core-ventiq' ),
			'move-down'	=>	esc_html__( "move-down", 'mascot-core-ventiq' ),
			'move-left'	=>	esc_html__( "move-left", 'mascot-core-ventiq' ),
			'move-right'	=>	esc_html__( "move-right", 'mascot-core-ventiq' ),
			'scale-up'	=>	esc_html__( "scale-up", 'mascot-core-ventiq' ),
			'fall-perspective'	=>	esc_html__( "fall-perspective", 'mascot-core-ventiq' ),
			'fly'	=>	esc_html__( "fly", 'mascot-core-ventiq' ),
			'flip'	=>	esc_html__( "flip", 'mascot-core-ventiq' ),
			'helix'	=>	esc_html__( "helix", 'mascot-core-ventiq' ),
			'pop-up'	=>	esc_html__( "pop-up", 'mascot-core-ventiq' )
		);
		return $class_list;
	}
}

if(!function_exists('mascot_core_ventiq_jquery_easings_list')) {
	/**
	 * easings list http://api.jqueryui.com/easings/
	 */
	function mascot_core_ventiq_jquery_easings_list() {
...
if(!function_exists('mascot_core_ventiq_orderby_parameters_list')) {
	/**
	 * Orderby Parameters list
	 */
	function mascot_core_ventiq_orderby_parameters_list() {
		$orderby_parameters_list = array(
			'date'	=>	esc_html__( 'Date', 'mascot-core-ventiq' ),
			'name'	=>	esc_html__( 'Post Name', 'mascot-core-ventiq' ),
			'rand'	=>	esc_html__( 'Random Order', 'mascot-core-ventiq' ),
			'modified'	=>	esc_html__( 'Last Modified Date', 'mascot-core-ventiq' ),
			'author'	=>	esc_html__( 'Author', 'mascot-core-ventiq' ),
			'title'	=>	esc_html__( 'Title', 'mascot-core-ventiq' ),
			'ID'	=>	esc_html__( 'ID', 'mascot-core-ventiq' ),
			'parent'	=>	esc_html__( 'Post/Page Parent ID', 'mascot-core-ventiq' ),
			'comment_count'	=>	esc_html__( 'Number of Comments', 'mascot-core-ventiq' ),
			'menu_order'	=>	esc_html__( 'Page Order', 'mascot-core-ventiq' )
		);
		return $orderby_parameters_list;
	}
}

if(!function_exists('mascot_core_ventiq_category_orderby_parameters_list')) {
	/**
	 * Category Orderby Parameters list
	 */
	function mascot_core_ventiq_category_orderby_parameters_list() {
		$orderby_parameters_list = array(
			esc_html__( 'name', 'mascot-core-ventiq' ) 	=> 'name',
			esc_html__( 'id', 'mascot-core-ventiq' ) 		=> 'id',
			esc_html__( 'count', 'mascot-core-ventiq' ) 	=> 'count',
			esc_html__( 'slug', 'mascot-core-ventiq' ) 	=> 'slug',
		);
		return $orderby_parameters_list;
	}
}

if(!function_exists('mascot_core_ventiq_isotope_gutter_list')) {
	/**
	 * Gutter list
	 */
	function mascot_core_ventiq_isotope_gutter_list() {
		if( mascot_core_ventiq_theme_installed() ) {
			return ventiq_isotope_gutter_list();
		} else {
			return array();
		}
	}
...
if(!function_exists('mascot_core_ventiq_different_size_list')) {
	/**
	 * Size list
	 */
	function mascot_core_ventiq_different_size_list() {
		if( mascot_core_ventiq_theme_installed() ) {
			return ventiq_different_size_list();
		} else {
			return array();
		}
	}
...
if(!function_exists('mascot_core_ventiq_get_post_all_categories_array')) {
	/**
	 * Category List of Blog Posts as an Array
	 */
	function mascot_core_ventiq_get_post_all_categories_array() {
		$categories = get_categories( array(
			'orderby' => 'name',
			'order'   => 'ASC'
		) );
		$cats = array();
		$cats[''] = esc_html__( 'All', 'mascot-core-ventiq' );
...
if(!function_exists('mascot_core_ventiq_get_page_list_array')) {
	/**
	 * Category List of Pages as an Array
	 */
	function mascot_core_ventiq_get_page_list_array() {
		$all_pages = get_pages();
		$pages = array();
...
if ( ! function_exists( 'mascot_core_ventiq_metabox_get_list_of_predefined_theme_color_css_files' ) ) {
	/**
	 * Get list of Predefined Theme Color css files
	 */
	function mascot_core_ventiq_metabox_get_list_of_predefined_theme_color_css_files() {
...
if ( ! function_exists( 'mascot_core_ventiq_category_list_array' ) ) {
	/**
	 * Return category list array
	 */
	function mascot_core_ventiq_category_list_array( $taxonomy ) {
		$list_categories = array(
			'' => esc_html__( 'All', 'mascot-core-ventiq' )
		);
...
if ( ! function_exists( 'mascot_core_ventiq_load_styles' ) ) {
	/**
	 * Get style array
	 */
	function mascot_core_ventiq_load_styles( $qty = 1, $param_name = 'design_style', $admin_label = false ) {
		$options = array();
		for ($i = 1; $i <= $qty; $i++) {
			$options[sprintf(esc_html__("Style %s", 'mascot-core-ventiq'), $i)] = "style{$i}";
		}

		$array = array(
			'type'       => 'dropdown',
			'heading'    => esc_html__('Design Style', 'mascot-core-ventiq'),
...
if(!function_exists('mascot_core_ventiq_get_btn_design_style')) {
	...
	function mascot_core_ventiq_get_btn_design_style() {
		if( mascot_core_ventiq_theme_installed() ) {
			return ventiq_get_btn_design_style();
		} else {
			return array();
		}
	}
...
if(!function_exists('mascot_core_ventiq_get_post_list_array_by_post_type_old')) {
	/**
	 * Return Post List Array By Post Type
	 */
	function mascot_core_ventiq_get_post_list_array_by_post_type_old( $cpt = '', $for_vc = false ) {
		$post_list = array();
		$args = array(
			'post_type'			=> $cpt,
			'posts_per_page'	=> -1,
...
if(!function_exists('mascot_core_ventiq_get_post_list_array_by_post_type')) {
	/**
	 * Return Post List Array By Post Type
	 */
	function mascot_core_ventiq_get_post_list_array_by_post_type( $cpt = '', $for_vc = false ) {
		$post_list = array();
		$post_list[''] = esc_html__( "Select Item", 'mascot-core-ventiq' );
		$args = array(
			'post_type'			=> $cpt,
			'numberposts'		=> -1,
			'orderby'			=> 'title',
...
if(!function_exists('mascot_core_ventiq_set_admin_ajax_url')){
	/**
	 * Set admin ajax url via javascript
	 *
	 */
	function mascot_core_ventiq_set_admin_ajax_url() {
		echo '<script type="application/javascript">var MascotCoreAjaxUrl = "'.admin_url('admin-ajax.php').'"</script>';
	}
	add_action('wp_enqueue_scripts', 'mascot_core_ventiq_set_admin_ajax_url');
}

if(!function_exists('mascot_core_ventiq_row_typography')){
	/**
	 * Return Row Typography Array
	 *
	 */
	function mascot_core_ventiq_row_typography() {
		$array = array();

		$array = array(
			"type"			=> 'dropdown',
			"heading"		=> esc_html__( "Row Typography", 'mascot-core-ventiq' ) ,
			"param_name"	=> "section_typo",
			"description"	=> esc_html__( "Define the color typography of the text of this row.", 'mascot-core-ventiq' ) ,
			"value" => array(
				esc_html__( 'Default', 'mascot-core-ventiq' ) => '',
				esc_html__( 'Light Typography - on Dark Background', 'mascot-core-ventiq' ) => 'section-typo-light',
				esc_html__( 'Dark Typography - on White Background', 'mascot-core-ventiq' ) => 'section-typo-dark',
			) ,
			"weight" => "99"
		);
...
if(!function_exists('mascot_core_ventiq_base_64_decode')){
	/**
	 * Return urldecode base64_decode
	 *
	 */
	function mascot_core_ventiq_base_64_decode($code) {
		return urldecode(base64_decode($code));
	}
}

if(!function_exists('mascot_core_ventiq_base_64_decode_raw_html')){
	/**
	 * Return rawurldecode base64_decode
	 *
	 */
	function mascot_core_ventiq_base_64_decode_raw_html($code) {
...
if(!function_exists('mascot_core_ventiq_get_animation_type')) {
	...
	function mascot_core_ventiq_get_animation_type() {
		$array = array(
			...
			esc_html__( 'Floating Animation', 'mascot-core-ventiq' )	=>	'tm-animation-floating',
			esc_html__( 'Horizontal Slide Animation', 'mascot-core-ventiq' )	=>	'tm-animation-slide-horizontal',

			esc_html__( 'Flicker Animation', 'mascot-core-ventiq' )	=>	'tm-animation-flicker',
			esc_html__( 'Spin Animation', 'mascot-core-ventiq' )	=>	'tm-animation-spin',


			esc_html__( 'Random Animation 1', 'mascot-core-ventiq' )	=>	'tm-animation-random-animation1',
			esc_html__( 'Random Animation 2', 'mascot-core-ventiq' )	=>	'tm-animation-random-animation2',
		);
		return $array;
	}
}
...
if(!function_exists('mascot_core_ventiq_masonry_image_sizes')) {
	/**
	 * Masonry Image Size list
	 */
	function mascot_core_ventiq_masonry_image_sizes() {
		$masonry_image_sizes = array(
			'mascot_core_square'			=> esc_html__( 'Default', 'mascot-core-ventiq' ),
			'mascot_core_wide'			=> esc_html__( 'Width', 'mascot-core-ventiq' ),
			'mascot_core_height'			=> esc_html__( 'Height', 'mascot-core-ventiq' ),
			'mascot_core_width_height'	=> esc_html__( 'Both Width & Height', 'mascot-core-ventiq' ),
		);
...
if(!function_exists('mascot_core_ventiq_heading_tag_list')) {
	/**
	 * Heading Tag List
	 */
	function mascot_core_ventiq_heading_tag_list() {
...
if(!function_exists('mascot_core_ventiq_wp_admin_dashicons_list')) {
	/**
	 * WordPress admin Dashicons https://developer.wordpress.org/resource/dashicons
	 */
	function mascot_core_ventiq_wp_admin_dashicons_list() {
		$animate_css_animation_list = array(
			'' => '',
...
if ( ! function_exists( 'mascot_core_ventiq_prepare_button_classes_from_params' ) ) {
	/**
	 * Return Button Classes Collecting From Params
	 */
	function mascot_core_ventiq_prepare_button_classes_from_params( $params = array(), $prefix = '' ) {
		$btn_classes = array();
...
if ( ! function_exists( 'mascot_core_ventiq_prepare_header_button_classes_from_params' ) ) {
	/**
	 * Return Header Button Classes Collecting From Params
	 */
	function mascot_core_ventiq_prepare_header_button_classes_from_params( $params = array(), $prefix = '' ) {
		$btn_classes = array();
...
if ( ! function_exists( 'mascot_core_ventiq_swiper_data_params' ) ) {
	/**
	 * Return Swiper Slider Data Collecting From Params
	 */
	function mascot_core_ventiq_swiper_data_params( $params = array(), $prefix = '' ) {
		$swiper_data = array();
...
if(!function_exists('mascot_core_ventiq_get_swiper_slider_arraylist')) {
	/**
	 * Return Swiper Slider Array List
	 */
	function mascot_core_ventiq_get_swiper_slider_arraylist( $control_object, $serial, $prefix = '', $dependency = array() ) {
		$array = array();

		//Swiper Slider Options
		$control_object->start_controls_section(
			'carousel_options', [
				'label' => esc_html__( 'Carousel/Slider Options', 'mascot-core-ventiq' ),
		...
		$control_object->add_responsive_control(
			'list_margin',
			[
				'label' => esc_html__( 'Item Margin', 'mascot-core-ventiq' ),
		...
		$control_object->add_control(
			$prefix . "xxl_swiper_items", [
				'label' => esc_html__( "Items Extra Extra Large (Over 1400px)", 'mascot-core-ventiq' ),
		...
		$control_object->add_control(
			$prefix . "swiper_items", [
				'label' => esc_html__( "Items Extra Large(Over 1200px)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "lg_swiper_items", [
				'label' => esc_html__( "Items Large (Between 992px to 1200px)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "md_swiper_items", [
				'label' => esc_html__( "Items Medium (Over 768px)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "sm_swiper_items", [
				'label' => esc_html__( "Items Small (Over 576px)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "xs_swiper_items", [
				'label' => esc_html__( "Items Extra Small (Below 576px)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "arrow", [
				'label' => esc_html__( "Show Arrow", 'mascot-core-ventiq' ),
		...
		$control_object->add_control(
			$prefix . "bullets", [
				'label' => esc_html__( "Show Pagination/Bullets", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . 'pagination_type', [
				'label' => esc_html__( "Pagination/Bullets Type", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'bullets' => esc_html__( 'Bullets', 'mascot-core-ventiq' ),
					'fraction' => esc_html__( 'Fraction', 'mascot-core-ventiq' ),
					'progressbar' => esc_html__( 'Progressbar', 'mascot-core-ventiq' ),
				],
				'default' => 'bullets',
				'condition' => [
		...
		$control_object->add_control(
			$prefix . 'slide_effect',
			[
				'label'   => esc_html__( 'Slide Effect', 'mascot-core-ventiq' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'slide',
				'options' => [
					'slide'     => esc_html__( 'Slide', 'mascot-core-ventiq' ),
					'fade'     => esc_html__( 'Fade', 'mascot-core-ventiq' ),
					'flip'      => esc_html__( 'Flip', 'mascot-core-ventiq' ),
					'cube'      => esc_html__( 'Cube', 'mascot-core-ventiq' ),
					'coverflow' => esc_html__( 'CoverFlow', 'mascot-core-ventiq' ),
					'cards' => esc_html__( 'Cards', 'mascot-core-ventiq' ),
				],
			]
		);
		//================ start popover
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'CoverFlow Settings', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off' => esc_html__( 'Default', 'mascot-core-ventiq' ),
				'label_on' => esc_html__( 'Custom', 'mascot-core-ventiq' ),
				'return_value' => 'yes',
				'default' => 'no',
				'condition' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Rotate', 'mascot-core-ventiq'),
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Stretch', 'mascot-core-ventiq'),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -500,
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Depth', 'mascot-core-ventiq'),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Modifier', 'mascot-core-ventiq'),
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Scale', 'mascot-core-ventiq'),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'min' => 0.1,
				'max' => 2,
				'step' => 0.1,
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Slide Shadows', 'mascot-core-ventiq'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'mascot-core-ventiq'),
				'label_off' => esc_html__('No', 'mascot-core-ventiq'),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
		...
		$control_object->add_control(
			$prefix . "autoplay", [
				'label' => esc_html__( "Autoplay", 'mascot-core-ventiq' ),
				'separator' => 'before',
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
		...
		$control_object->add_control(
			$prefix . 'delay',
			[
				'label' => esc_html__( 'Delay (ms)', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => 3000,
				'description' => esc_html__( "Time between slides in ms", 'mascot-core-ventiq' ),
				'condition' => [
						$prefix . 'autoplay' => 'yes',
				],
			]
		...
		$control_object->add_control(
			...
			[
				'label'     => esc_html__( 'Disable on Interaction', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'description' => esc_html__( "Keep autoplay running after user swipes", 'mascot-core-ventiq' ),
				'default' => 'false',
				'condition' => [
					$prefix . 'autoplay' => 'yes',
				],
		...
		$control_object->add_control(
			...
			[
				'label'     => esc_html__( 'Pause On Mouse Enter', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'description' => esc_html__( "Pause autoplay when mouse hovers over slider", 'mascot-core-ventiq' ),
				'default' => 'yes',
				'condition' => [
					$prefix . 'autoplay' => 'yes',
				],
		...
		$control_object->add_control(
			$prefix . "reversedir", [
				'label' => esc_html__( "Reverse Direction", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'description' => esc_html__( "Play slides in reverse order", 'mascot-core-ventiq' ),
				'default' => 'no',
				'condition' => [
					$prefix . 'autoplay' => 'yes',
				],
		...
		$control_object->add_control(
			...
			[
				'label'     => esc_html__( 'Allow Touch Move', 'mascot-core-ventiq' ),
				'separator' => 'before',
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		...
		$control_object->add_control(
			$prefix . "loop", [
				'label' => esc_html__( "Infinite Loop", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . "centered", [
				'label' => esc_html__( "Enabled Centered", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . 'space',
			[
				'label' => esc_html__( 'Space (px)', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$control_object->add_control(
			$prefix . 'speed',
			[
				'label' => esc_html__( 'Animation Speed (ms)', 'mascot-core-ventiq' ),
				'description' => esc_html__( "Duration in milliseconds (default is 300ms)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => 300,
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . "freemod", [
				'label' => esc_html__( "Free Mode", 'mascot-core-ventiq' ),
				'description' => esc_html__( "Scroll freely through slides", 'mascot-core-ventiq' ),
				'separator' => 'before',
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
				'condition' => $dependency
...
if(!function_exists('mascot_core_ventiq_get_swiper_slider_nav_arraylist')) {
	/**
	 * Return Owl Slider Nav Array List
	 */
	function mascot_core_ventiq_get_swiper_slider_nav_arraylist( $control_object, $serial, $prefix = '', $dependency = array() ) {
		$array = array();
		$control_object->start_controls_section(
			'swiper_arrow_styling', [
				'label' => esc_html__( 'Carousel/Slider Arrow Styling', 'mascot-core-ventiq' ),
...
if(!function_exists('mascot_core_ventiq_get_swiper_slider_dots_arraylist')) {
	/**
	 * Return Owl Slider Bullets/Dots List
	 */
	function mascot_core_ventiq_get_swiper_slider_dots_arraylist( $control_object, $serial, $prefix = '', $dependency = array() ) {
		$array = array();

		$control_object->start_controls_section(
			'swiper_dots_options', [
				'label' => esc_html__( 'Carousel/Slider Dots Styling', 'mascot-core-ventiq' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => $dependency
			]
		);
		$control_object->add_responsive_control(
			$prefix . "dots_display_visibility", [
				'label' => esc_html__( "Visibility in Responsive (Show/Hide)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'block' => [
						'title' => __( 'Show', 'mascot-core-ventiq' ),
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Bullets/Dots Position', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$control_object->add_control(
			$prefix . 'swiper_dots_pos_center', [
				'label' => esc_html__( "Dots Position Horizontal Center", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'selectors' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Bullets/Dots BG Options', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "BG Theme Color", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Bullet Size', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "BG Color (Active)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "BG Theme Color (Active)", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_ventiq_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Width (Active)', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Height (Active)', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
...
if(!function_exists('mascot_core_ventiq_gsap_animation_arraylist')) {
	/**
	 * Return GSAP Animation Array List
	 */
	function mascot_core_ventiq_gsap_animation_arraylist( $control_object, $prefix = '', $dependency = array() ) {
		$array = array();

		$control_object->add_control(
			'gsap_scrolling_effect',
			[
				'label' => esc_html__( "GSAP Scrolling Effect", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__('None', 'mascot-core-ventiq'),
					'parallax' => esc_html__('GSAP Parallax', 'mascot-core-ventiq'),
				],
				'default' => ''
			]
		);
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'GSAP Motion Animation', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off' => esc_html__( 'Default', 'mascot-core-ventiq' ),
				'label_on' => esc_html__( 'Custom', 'mascot-core-ventiq' ),
				'return_value' => 'yes',
		...
		$control_object->add_responsive_control(
			'gsap_motion_x',
			[
				'label' => esc_html__( "X", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => ''
			]
		);
		$control_object->add_responsive_control(
			'gsap_motion_y',
			[
				'label' => esc_html__( "Y", 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => ''
			]
		);
		...
		$control_object->add_responsive_control(
			'affectedRange',
			[
				'label' => esc_html__( 'Viewport', 'mascot-core-ventiq' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'default' => [
					'sizes' => [
						'start' => 0,
				...
				'labels' => [
					__( 'Bottom', 'mascot-core-ventiq' ),
					__( 'Top', 'mascot-core-ventiq' ),
				],
				'scales' => 1,
				'handles' => 'range',
			]
...
if(!function_exists('mascot_core_ventiq_gsap_animation_json_data')) {
	/**
	 * Return GSAP Animation Array List
	 */
	function mascot_core_ventiq_gsap_animation_json_data( $item ) {
