<?php
namespace MascotCoreVentiq\CPT;

use MascotCoreVentiq\Lib;

/**
 * class Reg_Post_Type
 * @package MascotCoreVentiq\CPT;
 */
class Reg_Post_Type {
	/**
	 ...
	 */
	private function add_new_post_type(Lib\Mascot_Core_Ventiq_Interface_PostType $newPostType) {
...
add_action('elementor/init','MascotCoreVentiq\CPT\tm_enable_elementor_for_all_cpt');