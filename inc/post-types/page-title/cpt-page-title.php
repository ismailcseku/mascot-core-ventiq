<?php
namespace MascotCoreVentiq\CPT\PageTitle;
 ...
 * Singleton class
 * class CPT_PageTitle
 * @package MascotCoreVentiq\CPT\PageTitle;
 */
final class CPT_PageTitle implements Lib\Mascot_Core_Ventiq_Interface_PostType {
	...
	private function __construct() {
		$this->ptSingularName = esc_html__( 'Parts - Page Title', 'mascot-core-ventiq' );
		$this->ptPluralName = esc_html__( 'Parts - Page Title', 'mascot-core-ventiq' );
	...
	public function customColumnsSettings( $columns ) {
		...
		$columns = array(
			...
			'active-page-title'	=> esc_html__( 'Currently Active Page Title', 'mascot-core-ventiq' ),
		...
		switch( $columns ) {
			case 'active-page-title' :
				if( mascot_core_ventiq_theme_installed() ) {
					$active_headertop_id = ventiq_get_redux_option( 'page-title-settings-choose-page-title-cpt-widget-area', 'default' );
